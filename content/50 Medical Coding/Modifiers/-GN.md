...
tags:
  ...
  - otolaryngology
title: -GN
description: "Modifier -GN: Services Delivered Under an Outpatient Speech-Language Pathology Plan of Care"
...
- **Swallowing therapy:** [[92526]] with [[-GN]].
- **Speech evaluation:** [[92521]] (fluency), [[92522]] (sound production), [[92523]] (language comprehension/expression), [[92524]] (voice analysis) — all require [[-GN]] for Medicare.
- **Cognitive-linguistic therapy:** [[97129]] (therapeutic interventions for cognitive function, 1st 15 min) and [[97130]] (each additional 15 min) with [[-GN]].
- **AAC device training:** [[92609]] (use of speech generating device) with [[-GN]].
- **Auditory rehabilitation:** [[92630]], [[92633]] with [[-GN]] when billed under SLP POC.
...
|------|-----|-----------|------|
| MM/DD/YYYY | [[92507]] | [[-GN]] | Individual SLP treatment, Medicare |
| MM/DD/YYYY | [[92507]] | [[-GN]] [[-95]] | SLP treatment via synchronous video telehealth |
| MM/DD/YYYY | [[92507]] | [[-GN]] [[-KX]] | SLP treatment exceeding annual therapy cap threshold |
| MM/DD/YYYY | [[92526]] | [[-GN]] | Swallowing therapy, Medicare |
...
1. Is this an **outpatient SLP service** billed under a speech-language pathology plan of care?
2. Is there a **current, certified SLP plan of care** on file?
3. Is [[-GN]] on **every** SLP claim line (not just one line on a multi-line claim)?
4. If charges exceed the therapy cap threshold, is [[-KX]] also appended?
5. If telehealth, is [[-95]] (audio-video) or [[-FQ]] (audio-only Medicare) also stacked with [[-GN]]?
