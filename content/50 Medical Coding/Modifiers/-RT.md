...
CMS guidance states **[[-LT]] and [[-RT]] shall not be reported when the 50 modifier applies**. 
Practical takeaway: choose **either** the bilateral modifier route (**-50**) **or** the two-line laterality route (**RT line + LT line**) per payer guidance; don’t combine them on the same line.
