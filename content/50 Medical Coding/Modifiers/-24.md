---
title: "-24"
description: Modifier -24 (Unrelated E/M During Post-op Period)
...
### Required elements
- **Identify index procedure + dates:** “Patient is in post-op global for: CPT` _________` on (DOS) `__________` .” 
- **State unrelated reason for visit:** “Today’s visit is for: `__________` (new/unrelated complaint/condition).”  
...
- “E/M today is **unrelated to the post-op care** of the prior surgery; evaluated/managed `_________`. Append **[[-24]]** to the E/M.”  
- “Post-op global period is active for prior surgery; today’s E/M addressed `_________` with separate management plan (med changes/orders/referrals).”  
