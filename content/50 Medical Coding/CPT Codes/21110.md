...
description: Application of a rigid interdental fixation device (for example, bonded arch bars or similar hardware) to immobilize the maxilla and mandible for non‑traumatic conditions, including later removal of the same device when healing or treatment is complete.
