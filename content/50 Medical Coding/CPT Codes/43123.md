...
code: 43123
code_type: CPT
description: Partial esophagectomy, cervical approach; without reconstruction
category: Surgery
...
---
## 😷 CPT Code 43123 - Partial Esophagectomy, Cervical Approach; Without Reconstruction
>
## **Code Description**
...
6. **Reconstruction Status** - **CRITICAL** (Must state "without reconstruction")
7. **Reason for No Reconstruction** - (e.g., staged, edema, contamination)
8. **Anastomosis/Stoma** - Describe if esophagostomy created
...
- "No reconstruction performed at this time"
- "Procedure staged for future reconstruction"
...
1. **Reconstruction Status** - The most critical audit point. If reconstruction is performed, 43124 must be used. If staged, 43123 is correct for the first stage.
...
4. **Assistant Surgeon** - Document medical necessity for assistant (complexity, exposure, hemostasis).
...
2. **Staged Reconstruction** - Often planned if patient is unstable or tissue quality is poor (e.g., radiation damage).
...
```
┌─────────────────────────────────────────────────────────┐
│  CPT 43123 - Partial Esophagectomy, Cervical, No Recon  │
├─────────────────────────────────────────────────────────┤
│  Global Period: 90 days                                 │
│  Assistant Allowed: Yes (Status 1)                      │
│  Bilateral: N/A (Midline)                               │
│  wRVU: 16.85                                            │
│  Key Documentation: Approach (Cervical), No Reconstruction│
