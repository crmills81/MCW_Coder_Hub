...
"description:":
  - With the patient under general or spinal anesthesia, the provider inserts a cystoscope through the urethra into the bladder.
  - The bladder is then hydrodistended with fluid to examine the mucosal lining and treat interstitial cystitis.
category: Surgery
subcategory:
  - Urinary System
specialty:
