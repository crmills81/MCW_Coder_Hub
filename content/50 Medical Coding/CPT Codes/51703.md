...
code: "51703"
code_type: CPT
code_title: Insertion of Temporary Indwelling Bladder Catheter; Complicated (eg, altered anatomy, fractured catheter/balloon)
description: Placement of a temporary indwelling (Foley) bladder catheter when insertion is complicated by altered anatomy, urethral stricture, BPH, or catheter/balloon fracture, requiring additional technique (e.g., coudé catheter, guidewire) to achieve successful bladder drainage.
...
>[!caution]
> **[[51701]], [[51702]], [[51703]]**: These are often bundled and not separately billable when performed as part of a larger surgical procedure (like a **[[cystourethroscopy|Cystourethroscopy]]**)
>
---

## Documentation requirements (what auditors look for)
Use a short “**why + what you did + outcome**” structure, and make the “**complicated**” component unmistakable. 
...
- **Work RVU:** Approximately **1.20 - 1.50** (Significantly higher than **[[51702]]**).
