...
specialty_tags: ["urology", "endoscopy", "ureteroscopy", "stones", "lithotripsy"]
cpt: "52353"
---
...
| **Global period** | **Verify in CMS MPFS Look-Up Tool** (global indicator varies by code and year). |
| **wRVU / RVU components** | **Verify in CMS MPFS Look-Up Tool** for your year/locality and facility vs non-facility setting. |
| **Medicare fee schedule (physician)** | Use MPFS Look-Up Tool (year + locality + facility/non-facility) for the allowed amount.  |
...
### What is performed
The clinician performs cystourethroscopy (bladder/urethra endoscopy), advances to ureteroscopy and/or pyeloscopy (upper tract endoscopy), identifies a calculus, and uses **lithotripsy** to fragment the stone. [web:395]  
In typical operative practice, fragmented stone material may be removed with a basket/forceps and/or allowed to pass, and irrigation is used for visualization and fragment management. [web:395]
...
> Coding tip: Pair the **anatomic [[stone]] diagnosis** (kidney vs ureter) with obstruction/infection codes only when documentation supports them.
