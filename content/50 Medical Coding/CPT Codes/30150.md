...
- Wound checks and dressing changes during the **90-day global period** — separately identifiable visits outside the global are not separately billable unless a new, unrelated problem is addressed (with appropriate modifier and documentation)
...
| **Modifier [[-8]]0** | Assistant surgeon, full participation; bills 20% of the primary surgeon's fee (Medicare pays 16% of the allowed amount after 20% patient co-pay) |
...
**CPT:** 30150 — Rhinectomy, partial (stage 1 resection)
