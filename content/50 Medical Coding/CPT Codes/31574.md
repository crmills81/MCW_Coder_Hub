...
"description:": Laryngoscopy Flexible with Injection of Vocal Cord
aliases:
  - "31574"
  - Flexible Laryngoscopy with Vocal Cord Injection
  - Vocal Cord Injection Laryngoscopy
  - Office Based Vocal Cord Injection
code_type: CPT
code_number: "31574"
...
- **Diagnosis:** [[50 Medical Coding/ICD-10 Codes/R49.0]] (dysphonia), [[J38.1]] (polyps of vocal cord and larynx) [or appropriate nodule code]
...
7. **Vocal Cord Movement:**
   ...
   - Range of motion
1. **Specific Findings** - If pathology present:
   - Location (anterior, middle, posterior third)
   - Size (mm if measurable)
   - Type (nodule, polyp, cyst, scarring, etc.)
1. **Stroboscopic Parameters - CRITICAL:**
   - Glottic closure pattern
   - Mucosal wave characteristics
   - Symmetry of vibration
   - Periodicity and regularity
   - Amplitude of motion
1. **Video Recording** - Documented as obtained and archived
2. **Overall Assessment** - Normal vs. abnormal; specific diagnosis
3. **Comparison to Prior Studies** - If prior laryngoscopy available
4. **Recommendations** - Voice therapy, follow-up, imaging, surgical consideration, etc.
5. **Complications** - None or specific issues
