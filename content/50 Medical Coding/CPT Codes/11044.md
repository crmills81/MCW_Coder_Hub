...
global_period: "000"
wRVU: 9.35 (non-facility) / 6.61 (facility) — ⚠️ historical CY2022 MPFS value; CONFIRM against CY2026 CMS MPFS Final Rule (CMS-1832-F), as CMS finalized a -2.5% "efficiency adjustment" to work RVUs for CY2026 that may affect this value
place_of_service:
  - 11 - Office
...
> **wRVU:** 9.35 (**NF**) / 6.61 (**Fac**) ⚠️ verify CY2026 | **Global Period:** **<font color="#ff0000">000 (same day)</font>** | **Assistant Payable:** ⚠️ Verify against **CMS MPFS** assistant-at-surgery indicator | **Bilateral Indicator:** 0 — not a paired-organ code; separate wounds are billed with **laterality/distinct-site modifiers** rather than **[[-50]]**
> 
...
| Component | Value |
|---|---|
| **Work RVU (wRVU)** | **9.35 (non-facility) / 6.61 (facility)** *(⚠️ historical CY2022 CMS MPFS value — CONFIRM current figure against the CY2026 CMS MPFS Final Rule/Addendum B, as CMS finalized a -2.5% work RVU "efficiency adjustment" that may apply to this code for CY2026)* |
