...
team_surgery: "N/A"
hcc_condition: false
hcc_notes: "CPT codes do not carry HCC status. Upper tract urothelial carcinoma diagnoses (C65.x, C66.x, C64.x) = HCC-12. See HCC section below."
wrvu_2026_estimated: 20.02
wrvu_2025_baseline: 20.52
conversion_factor_qualifying_apm_2026: 33.57
conversion_factor_nonqualifying_apm_2026: 33.40
...
8. The specimen (kidney + entire ureter ± bladder cuff) is placed in a specimen retrieval bag and extracted through an extended port site or a separate Pfannenstiel incision
9. The bladder is irrigated and a urethral catheter is placed
10. Ports are removed, fascia closed at extraction site, skin closed
