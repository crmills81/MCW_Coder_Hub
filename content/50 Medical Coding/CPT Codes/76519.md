...
> **HCC 19 documentation tip:** When diabetes causes the cataract, using E11.36 is both clinically more accurate and more complete for HCC risk adjustment — E11.36 maps to HCC 19, capturing the diabetes with its ocular complication. This carries meaningful risk adjustment weight that would be missed if only a generic cataract code is used.
