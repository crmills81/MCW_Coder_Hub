...
> 💡 The CC/MCC status is determined by the secondary diagnosis codes. Accurate and thorough documentation of the patient's comorbidities (e.g., malnutrition [[E44.0]], sepsis [[A41.9]], respiratory failure [[J69.0]]) has a **direct and significant impact** on DRG assignment and facility payment. Clinical documentation improvement (CDI) queries are often warranted for adhesiolysis patients admitted in poor condition.
