...
tags:
  ...
  - ophthalmology
code_title: Tonic pupil, right eye
aliases:
  - Tonic pupil right eye
  - Adie pupil right eye
  - Adie syndrome right eye
...
includes_terms:
  ...
  - Adie-Holmes syndrome right eye
  - Light-near dissociation right eye
  - Cholinergic supersensitivity of pupil right eye
date_created: 2026-05-12
last_reviewed: 2026-05-12
status: Active ✅
---

# 🧬 ICD-10 CM H57.051 — Tonic Pupil, Right Eye

> [!success] Billable Code Confirmed
>
> **ICD-10-CM H57.051** is a valid, billable **6-character ICD-10-CM code** for FY2026. Characters 1-3 (H57) define the category "**Other disorders of eye and adnexa**"; character 4 (0) narrows to anomalies of pupillary function; character 5 (5) specifies **tonic pupil**; and character 6 (t) specifies right eye laterality. No additional characters are required.
...
>
> Always submit **H57.051** (all 6 characters) when tonic pupil of the right eye is documented.
...
### Excludes 1 — Cannot Be Coded Simultaneously with H57.051

| Code | Description | Note |
| ---- | ----------- | ---- |
| No official Excludes 1 restrictions | — | H57.051 has no Excludes 1 restrictions in FY2026 |

> [!danger] Excludes 1 Violation Risk
> Do **not** report **[[H57.051]]** alongside **H57.04 (Mydriasis)** for the same eye on the same encounter — while tonic pupil presents with **mydriasis**, the specific tonic pupil code fully captures this finding. Coding both for the same eye is redundant and constitutes a specificity error. **[[H57.04]]** may be used for the unaffected fellow eye only if separately documented.
...
| Feature | **H57.051 — Tonic Pupil Right Eye** | **[[H57.04]] — Mydriasis** | **[[H57.02]] — Anisocoria** |
|---|---|---|---|
...
> **Clinical Vignette:** A 28-year-old female presents to ophthalmology reporting that her right pupil has looked "bigger than the other one" for about three weeks. She denies diplopia, ptosis, or headache. Slit-lamp examination reveals segmental contractions of the right eye iris sphincter. Dilute pilocarpine 0.1% instilled into the right eye eye produces brisk constriction, confirming cholinergic supersensitivity. No systemic etiology is identified. The provider documents: "Adie tonic pupil, right eye, idiopathic."

**CPT (Profee):**
- [[92004]] — Ophthalmological services, new patient, comprehensive

**ICD-10-CM:**
- [[H57.051]] — Tonic pupil, right eye *(principal/first-listed; idiopathic, no additional etiologic code)*
...
| ❌   | **Coding H57.04 (Mydriasis) instead of H57.051.** Tonic pupil presents with **mydriasis**, but when the specific diagnosis of tonic pupil or **Adie pupil** is documented, **H57.051** is the correct and more specific code — do **not** downcode to the generic mydriasis code.                                                                              |
