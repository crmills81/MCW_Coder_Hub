...
3. **[[N31.9]] – Neuromuscular dysfunction of bladder, unspecified:** *(Documentation Check)* – This is the default code if the provider just writes "[[Neurogenic Bladder]]" **Do not use N31.1** unless the provider specifically documents "**reflex**," "**spastic**," or "**hyperreflexic**" **neurogenic** bladder.
