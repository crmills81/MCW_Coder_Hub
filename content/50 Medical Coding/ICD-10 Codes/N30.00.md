...
## Short Description
**N30.00**: Use for **acute bladder infection (cystitis) when the patient does NOT have blood in the urine** - this is the most common uncomplicated UTI code for bladder infections presenting with dysuria, frequency, urgency, and suprapubic pain but **NO hematuria** (no blood in urine, either visible or microscopic).[web:200][web:201][web:203][web:204]

---

## Full Description & Clinical Context
**N30.00 - Acute cystitis without hematuria** describes **acute inflammation of the bladder (cystitis)** typically caused by bacterial infection, presenting with classic UTI symptoms but **without any evidence of blood in the urine**.[web:200][web:201][web:202][web:204]

**Key Clinical Features:**[web:202][web:204]
...
**Common causative organisms:**[web:202][web:204]
...
**Pathophysiology:**[web:202][web:204]
Bacteria (usually from GI tract) ascend through urethra → colonize bladder → cause inflammation of bladder mucosa → acute symptoms develop over hours to days.[web:202][web:204]
...
- **Code set:** ICD-10-CM
- **Full code:** N30.00
- **Title:** Acute cystitis without hematuria[web:200][web:201]
- **Code type:** Billable/specific diagnosis code[web:200][web:201]
- **Clinical category:** Cystitis (bladder infection)[web:200][web:203]
- **Parent code:** N30.0 (Acute cystitis)[web:200][web:201]

**Coding notes from N30:**[web:200][web:205][web:206]
- **Use additional code** to identify infectious agent (B95-B97) when organism identified on culture[web:200]
- **Excludes 1:** 
  - Prostatocystitis → N41.3[web:200]
- **From N30.0 (parent):**
  - **Excludes 1:** Irradiation cystitis → N30.4-[web:200]
  - **Excludes 1:** Trigonitis → N30.3-[web:200]
...
| **N30.01** | **Acute cystitis WITH hematuria** | Acute bladder infection WITH blood in urine (visible or microscopic)[web:203][web:205] |
| **N30.10** | Interstitial cystitis (chronic) without hematuria | Chronic IC/BPS, no hematuria[web:203][web:205] |
| **N30.11** | Interstitial cystitis (chronic) with hematuria | Chronic IC/BPS WITH hematuria[web:203][web:205] |
| **N30.20** | Other chronic cystitis without hematuria | Chronic bladder inflammation, no hematuria[web:203][web:205][web:206] |
| **N30.21** | Other chronic cystitis with hematuria | Chronic bladder inflammation WITH hematuria[web:203][web:205][web:206] |
| **N30.30** | Trigonitis without hematuria | Inflammation of bladder trigone, no hematuria[web:203][web:205] |
| **N30.31** | Trigonitis with hematuria | Trigone inflammation WITH hematuria[web:203][web:205] |
| **N30.40** | Irradiation cystitis without hematuria | Post-radiation bladder inflammation, no hematuria[web:203][web:205] |
| **N30.41** | Irradiation cystitis with hematuria | Post-radiation cystitis WITH hematuria[web:203][web:205] |
| **N30.80** | Other cystitis without hematuria | Other specified cystitis types, no hematuria[web:203] |
| **N30.81** | Other cystitis with hematuria | Other specified cystitis WITH hematuria[web:203] |
| **N30.90** | Cystitis, unspecified without hematuria | Unspecified type, no hematuria[web:203] |
| **N30.91** | Cystitis, unspecified with hematuria | Unspecified type WITH hematuria[web:203] |

[web:203][web:205][web:206]

**Coding Principle:**[web:203][web:204][web:207]
- The **5th character (0 vs 1)** distinguishes **WITHOUT hematuria (0)** from **WITH hematuria (1)**
- Hematuria can be **visible (gross) OR microscopic** (positive on UA)[web:207]
- If urinalysis shows blood (even trace/microscopic), use the "with hematuria" code (N30.01)[web:207]
- If no blood detected at all, use N30.00[web:204][web:207]
...
**Use N30.00 when:**[web:200][web:204][web:207]
...
**Use N30.01 when:**[web:203][web:207]
- Patient has acute cystitis/UTI symptoms
...
**Common Documentation Question:**[web:207]
> "Does 'with hematuria' refer to GROSS hematuria only, or microscopic too?"

**Answer:** The code applies to **BOTH visible (gross) AND microscopic hematuria**.[web:207]
- If the urinalysis detects blood (even occult/microscopic), code **N30.01**
- The "with hematuria" codes (x1) capture ANY presence of blood, not just visible blood[web:207]
- If patient didn't SEE blood but lab FOUND blood → still code N30.01[web:207]

---

## When to Use N30.00

Use **N30.00 ONLY when ALL are true:**[web:200][web:204]

1. **Acute cystitis diagnosed** - provider documents "acute cystitis," "UTI," "bladder infection," etc.[web:200][web:204]

2. **Classic UTI symptoms present:**[web:204]
...
|----------|---------|-----|
| **Hematuria present (visible OR microscopic)** | **N30.01** | ANY blood in urine = "with hematuria"[web:203][web:207] |
| **Chronic/recurrent cystitis** | **N30.20/N30.21** | Not acute; chronic inflammation[web:203][web:205][web:206] |
| **Interstitial cystitis/painful bladder** | **N30.10/N30.11** | Specific IC/BPS diagnosis[web:203][web:205] |
| **Trigonitis specifically documented** | **N30.30/N30.31** | Specific anatomic location[web:203][web:205] |
| **Post-radiation cystitis** | **N30.40/N30.41** | Specific etiology (radiation)[web:203][web:205] |
| **Prostatocystitis (males)** | **N41.3** | Prostate + bladder involvement[web:200] |
| **Pyelonephritis/kidney infection** | **N10/N11/N12** | Upper tract, not just bladder[web:204] |
...
**ICD-10-CM instruction: "Use additional code to identify infectious agent (B95-B97)"**[web:200]

When the specific organism is identified (usually from urine culture), assign a secondary code:[web:200]

| Organism | Code | Example |
|----------|------|---------|
| E. coli | **B96.20** (Unspecified E. coli) or B96.2x | Most common cause[web:202] |
...
**Note:** Many facilities code only N30.00 in practice and don't routinely add B95-B97 codes unless culture results are back and provider specifically documents the organism as causative.[web:200]

---

## HCC Information

- **N30.00 does NOT map to a CMS-HCC** - acute bladder infections are not risk-adjusted conditions[web:170]
...
- Office visit: 99212-99214 (established) or 99202-99204 (new)
