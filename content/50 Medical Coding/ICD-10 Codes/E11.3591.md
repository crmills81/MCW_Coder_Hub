...
tags:
  ...
  - ICD-10-CM
code: E11.3591
description: Type 2 diabetes mellitus with proliferative diabetic retinopathy without macular edema, right eye
...
# 🧬ICD-10 CM E11.3591 - Type 2 diabetes mellitus with proliferative diabetic retinopathy without macular edema, right eye
>
## Overview
**ICD-10 CM [[E11.3591]]** is a specific combination code used to classify **Type 2 diabetes mellitus** complicated by **proliferative diabetic retinopathy (PDR)** **without** **macular edema**, specifically localized to the **right eye**. This code captures the systemic disease, the specific ocular complication, the severity of the [[retinopathy]] (**proliferative**), the absence of [[edema]], and the laterality in a single alphanumeric string.

Accurate coding of [[E11.3591]] is critical for **risk adjustment**, severity of illness scoring, and ensuring appropriate reimbursement. It distinguishes the condition from **nonproliferative diabetic retinopathy (NPDR)** codes (such as [[E11.3391]] or [[E11.3491]]), indicating a more advanced stage of disease with [[neovascularization]], which carries higher clinical risk and resource utilization. It also differentiates cases without macular edema from those with edema ([[E11.3511]]).

## Code Breakdown
The structure of [[E11.3591]] follows the ICD-10-CM taxonomy:
...
### Excludes
*   **Type 1 Diabetes:** If the patient has Type 1 diabetes, codes from category E10 must be used (e.g., [[E10.3591]]).
...
*   **Nonproliferative Retinopathy:** If the retinopathy is nonproliferative (**mild, moderate, or severe**), codes from the `.31`, `.33`, or `.34` series are required (e.g., [[E11.3491]]).
*   **Macular Edema:** If **macular edema** is present, codes from the `.351` series are required (e.g., [[E11.3511]]).
*   **Background Retinopathy:** Use specific PDR codes instead of background terminology.

### Use of Additional Codes
While [[E11.3591]] is a combination code, additional codes may be required to fully capture the clinical picture:
...
In the inpatient setting, [[E11.3591]] influences the Medicare Severity Diagnosis Related Group (MS-DRG) assignment through Complication/Comorbidity (CC) logic.
...
**Scenario:** A patient with known Type 2 diabetes presents for a routine retina follow-up. Dilated exam reveals proliferative diabetic retinopathy without [[macular edema]] in the right eye. Left eye shows severe NPDR without edema.
**Coding:**
*   Primary: [[E11.3591]] (PDR without ME, Right Eye)
...
**Scenario:** Patient previously coded with [[E11.3591]] returns. Exam now shows [[proliferative diabetic retinopathy]] with macular edema in the right eye.
**Coding:**
...
**Scenario:** Patient with Type 2 diabetes coded as [[E11.3591]] is on long-term insulin therapy.
**Coding:**
*   Primary: [[E11.3591]]
...
*   **Denial Risk:** High if paired with incompatible procedure codes (e.g., anti-VEGF injection without documented macular edema, as [[E11.3591]] specifies *without* macular edema).
...
*   **Absence of Macular Edema:** For [[E11.3591]], clinical imaging (OCT) must confirm no thickening or fluid accumulation in the macula.

> [!NOTE] Treatment Implications
> PDR typically requires **panretinal photocoagulation (PRP)** laser therapy and/or intravitreal anti-VEGF injections. Documentation of these treatments supports the severity of the diagnosis coded as [[E11.3591]]. However, anti-VEGF is often specifically indicated for PDR *with* **macular edema**; coding [[E11.3591]] (without edema) alongside anti-VEGF claims may trigger medical necessity reviews unless PDR-specific indications are documented.
