...
**ICD-10 CM [[H33.309]]** is the **least specific** code in the **H33.3 family** on two independent dimensions — both the eye laterality and the break type are unspecified. As a profee coder working inpatient and outpatient retina charts, **[[H33.309]]** should function as a **CDI red flag** every time it appears: the eye laterality is almost always determinable from the dilated fundus exam documentation, and the break type (horseshoe vs. round hole vs. multiple defects) is typically described in the slit lamp or indirect ophthalmoscopy findings. Defaulting to **[[H33.309]]** when the clinical documentation supports a more specific code represents both a coding accuracy failure and a missed opportunity to capture the clinically meaningful distinction between break types that drives treatment decisions.<sup>3</sup>
...
- **CPT crosswalk:** [[67141]], [[67145]], [[92201]], [[92202]], [[92134]], [[92250]]
