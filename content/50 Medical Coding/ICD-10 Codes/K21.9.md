...
**K21.9** is used for **gastro-esophageal reflux disease (GERD) without esophagitis** - when stomach acid flows back into the esophagus causing symptoms but **without evidence of inflammatory damage or erosion** to the esophageal lining.[web:440][web:441][web:442] This is the most common form of GERD, representing symptomatic acid reflux without esophagitis.[web:441][web:444]

**Key distinction:** This code applies when reflux symptoms are present but endoscopy (if performed) shows **no esophagitis**, or when GERD is diagnosed clinically without endoscopic evidence of inflammation.[web:441][web:442]

---

## Full Description & Clinical Context

**Gastro-esophageal reflux disease (GERD)** is a chronic condition where gastric contents (acid, pepsin, bile) reflux from the stomach into the esophagus due to lower esophageal sphincter (LES) dysfunction.[web:441][web:442] When the LES doesn't close properly, acidic stomach contents can move up into the esophagus, causing symptoms.[web:441]

**K21.9 specifically indicates:**[web:440][web:441][web:442]
...
- Patient experiences typical reflux symptoms (heartburn, regurgitation) without endoscopic evidence of esophageal injury[web:441][web:444]

**Clinical presentation:**[web:441][web:442][web:444]
...
- Symptoms typically occur ≥2 times per week[web:441]

**K21.9 diagnosis criteria:**[web:441][web:444]
...
- pH monitoring confirms pathologic acid exposure without esophagitis[web:441]

**Important:** If endoscopy reveals esophagitis, K21.9 is **NOT appropriate** - use K21.0 or K21.01 instead.[web:441][web:444]
...
- **Code set:** ICD-10-CM
- **Full code:** K21.9
- **Description:** Gastro-esophageal reflux disease without esophagitis[web:440][web:442]
- **Parent code:** K21 - Gastro-esophageal reflux disease[web:448]
- **Code type:** Billable/specific diagnosis code[web:441][web:442]
- **Synonyms/Includes:** Esophageal reflux NOS, GERD NOS (without esophagitis), acid reflux[web:440]

**Excludes at K21:**[web:440]
...
**Critical distinction: Presence or absence of esophagitis**[web:441][web:444][web:445]

| Code | Description | Esophagitis? | Bleeding? | Severity |
|------|-------------|--------------|-----------|----------|
| **K21.9** | **GERD without esophagitis** | **NO** | **N/A** | **Mild** (symptomatic only)[web:441][web:442] ← YOU ARE HERE |
| K21.0 | GERD with esophagitis, without bleeding | YES | NO | Moderate (inflammation present)[web:444][web:445] |
| K21.01 | GERD with esophagitis and bleeding | YES | YES | Severe (inflammation + bleeding)[web:441] |

**MOST CRITICAL CODING RULE:**[web:441][web:444]
- **If endoscopy shows esophagitis → CANNOT use K21.9**
- **If endoscopy shows NO esophagitis → use K21.9**
- **If no endoscopy performed and clinical GERD diagnosis → K21.9 is appropriate**[web:441]
...
| **Endoscopy findings** | Normal esophageal mucosa OR not performed | Erosions, ulcers, inflammation documented[web:444] |
| **Severity** | Milder, symptomatic only | More severe, tissue damage present |
| **Documentation required** | Symptoms + no esophagitis documented OR clinical diagnosis | Esophagitis explicitly documented[web:441] |
| **Typical use** | Clinical GERD diagnosis, normal endoscopy | Abnormal endoscopy with inflammation |
| **Common in practice** | Very common (majority of GERD)[web:444] | Less common |

**Key rule:** The **presence or absence of esophagitis** is THE defining difference between K21.9 and K21.0.[web:441][web:444]

---

## When to Use K21.9

Use **K21.9** when **ALL** of the following are true:[web:441][web:442][web:444]

1. **GERD is diagnosed:**
   - Provider documents "GERD," "gastroesophageal reflux disease," "acid reflux disease," or "esophageal reflux"[web:440][web:442]
   - Typical symptoms present (heartburn, acid regurgitation)

2. **Esophagitis is ABSENT:**[web:441][web:444]
...
3. **Condition is chronic/recurrent:**
   ...
   - Symptoms typically ≥2 times per week or requiring ongoing treatment[web:441]

**Typical scenarios:**[web:441][web:444]
...
Do **NOT** use K21.9 when:[web:441][web:444][web:445]

| Scenario | Use Instead | Rationale |
|----------|-------------|-----------|
| **Esophagitis IS documented** | **K21.0** | Inflammation present[web:444][web:445] |
| **Esophagitis + bleeding documented** | **K21.01** | More severe with hemorrhage[web:441] |
...
| **Newborn reflux** | **P78.83** | Neonatal-specific code[web:440] |
...
**Critical error to avoid:** Coding K21.9 when endoscopy report **clearly documents esophagitis** - this is under-coding and inaccurate.[web:441][web:444]

---

## Documentation Requirements for K21.9

**MINIMUM documentation to support K21.9:**[web:441][web:442]

✅ **MUST include:**

1. **Diagnosis of GERD explicitly stated:**
   - "GERD," "gastroesophageal reflux disease," "acid reflux disease," "chronic reflux"[web:442]
   - OR detailed symptom description supporting GERD (chronic heartburn + regurgitation)

2. **Absence of esophagitis documented OR implied:**[web:441][web:444]
...
❌ **CANNOT use K21.9 if:**
- Endoscopy report states "esophagitis," "erosive esophagitis," "LA grade A/B/C/D esophagitis" → must use K21.0[web:441][web:444]
- Documentation says "rule out GERD" in outpatient setting → use symptom codes until confirmed

✅ **SHOULD document (best practice):**[web:441][web:442]
...
- **Endoscopy results** (if performed): "EGD shows normal esophageal mucosa, no esophagitis"[web:441]
...
**Important coding principle:**[web:441]

**Endoscopy is NOT required to code K21.9:**
- Initial GERD diagnosis can be based on typical symptoms and response to PPI trial[web:441]
...
**If endoscopy IS performed:**[web:441][web:444]
...
**K21.9 does NOT map to any CMS-HCC.**[web:446]
...
**Key Concept:** **K21.9** is for GERD when **esophagitis is NOT present**. The critical distinction is whether endoscopy (if performed) shows esophageal inflammation. If esophagitis is documented, you MUST use K21.0 or K21.01 instead. Clinical diagnosis without endoscopy is acceptable for K21.9, but if endoscopy is performed and shows esophagitis, K21.9 cannot be used.[web:441][web:442][web:444]
