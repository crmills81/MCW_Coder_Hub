...
tags:
  ...
  - ICD-10-CM
code: E11.3311
description: Type 2 diabetes mellitus with moderate nonproliferative diabetic retinopathy with macular edema, right eye
category: Endocrine, Nutritional and Metabolic Diseases
chapter: Chapter 4 (E00-E89)
block: Diabetes mellitus (E08-E13)
subcategory: Type 2 diabetes mellitus (E11)
specialty: Endocrinology, Ophthalmology, Internal Medicine, Primary Care
hcc_status: Yes
...
| **Extension** | `E11.33` | Type 2 diabetes mellitus with moderate nonproliferative diabetic retinopathy |
| **Further Extension** | `E11.331` | Type 2 diabetes mellitus with moderate nonproliferative diabetic retinopathy with macular edema |
...
**Scenario:** A patient with known Type 2 diabetes presents for a routine ophthalmology follow-up. Dilated exam reveals **moderate nonproliferative diabetic retinopathy with macular edema in the right eye**. Left eye is clear.
**Coding:**
*   Primary: [[E11.3311]]
*   Secondary: [[Z79.4]] (if on insulin)

### Example 2: Bilateral Involvement
**Scenario:** Patient has Type 2 diabetes. Exam shows moderate NPDR with macular edema in both eyes.
**Coding:**
*   Primary: [[E11.3313]] (Do not use [[E11.3311]] and [[E11.3312]] together; use the bilateral code).

### Example 3: Progression to Proliferative
**Scenario:** Patient previously coded with [[E11.3311]] returns. Exam now shows proliferative diabetic retinopathy in the right eye with macular edema.
**Coding:**
...
**Scenario:** Documentation states "Diabetic retinopathy with macular edema" but does not specify left or right, and the provider cannot be queried before claim submission.
**Coding:**
*   Primary: [[E11.3319]]
*  >[!note] *Note:* Query the provider to specify laterality whenever possible to avoid unspecified codes.
