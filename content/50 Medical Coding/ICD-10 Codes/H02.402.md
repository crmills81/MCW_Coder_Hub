...
| **Functional Impact** | Superior visual field loss, brow strain, frontal headaches, chin-up posture[2][3] |
| **HCC Status** | No (non-HCC) |
| **Excludes1** | Congenital eyelid malformations Q10.0-Q10.3[4][5] |

---

## Short Definition

**H02.402** describes **ptosis (drooping) of the left upper eyelid** when the type or cause of ptosis (mechanical, myogenic, paralytic, etc.) is **not specified** in the documentation.[2][4][6] It is used for acquired eyelid droop affecting the left eye that is clinically significant but etiologically unspecified.
...
- **Ptosis** = drooping of the upper eyelid that may partially or completely cover the pupil and reduce vertical palpebral fissure height.[2]
- **H02.402** is used when:
  - Ptosis is **acquired** (not clearly congenital).
  - The side is **left eyelid**.
  - The chart **does not specify** whether the ptosis is mechanical, myogenic, paralytic, or other subtype.[4][6]
- Documentation phrases that map here:
  - “Left eyelid ptosis”
  - “Droopy left upper lid”
  - “Left upper eyelid droop (cause unclear)”[2][6]

When a specific mechanism is documented (mechanical/myogenic/paralytic), you should move to the more specific child codes (H02.41x, H02.42x, H02.43x) instead of H02.402.[4][5]

### Etiology & Pathophysiology (High-Yield)

Common acquired causes of ptosis (even if unspecified for coding):[2][3]
...
- **Myogenic**
  ...
  - Often fatigable or variable ptosis that worsens during the day.[2]

- **Neurogenic**
  - Third-nerve palsy, Horner syndrome, or other cranial/sympathetic lesions.
  - May be associated with anisocoria, motility deficits, or anhidrosis.[2][3]

- **Mechanical**
  - Excess skin (dermatochalasis), edema, tumors, scarring, or heavy lesions weighting the lid.[2][3]
...
Red flags suggesting specific causes:[2][3]
...
| 4th | .4 | Ptosis of eyelid[4][5] |
| 5th-6th | 02 | Unspecified ptosis of left eyelid[6][7] |

H02.402 is **fully specified and billable** as written; it does **not** require any additional characters.[4][6]
...
- Ptosis is **acquired**, not clearly congenital.
- Ptosis is clinically meaningful (symptoms, visual complaints, or objective field loss).[2][4][6]

**Do NOT use H02.402 when:**

- Ptosis is **congenital** → use Q10.0-Q10.3 (Excludes1 for H02.4).[4]
- Provider clearly documents:
  - **Mechanical ptosis** of left eyelid → H02.412.[4][7]
  - **Myogenic ptosis** of left eyelid → H02.422.[4][7]
  - **Paralytic ptosis** of left eyelid → H02.432.[4][7]
- Laterality differs:
  - Right eyelid: [[H02.401]].
  - Bilateral eyelids: [[H02.403]].
  - Unspecified eyelid: [[H02.409]].[4][6]
...
|------|-------------|------------|
| **H02.402** | **Unspecified ptosis of left eyelid** | **Acquired left ptosis, type not documented (THIS)**[6] |
| H02.401 | Unspecified ptosis of right eyelid | Same, right side[7] |
| H02.403 | Unspecified ptosis of bilateral eyelids | Both lids, type not documented[6][8] |
| H02.409 | Unspecified ptosis of unspecified eyelid | Site unknown/not documented (avoid if possible)[4] |
| [[H02.412]] | Mechanical ptosis of left eyelid | Dermatochalasis, masses, scarring specified[4][7] |
| [[H02.422]] | Myogenic ptosis of left eyelid | MG or muscle disorder clearly stated[2][7] |
| [[H02.432]] | Paralytic ptosis of left eyelid | Third-nerve palsy, Horner syndrome documented[2][7] |
| H02.83x | Dermatochalasis of eyelid | Redundant eyelid skin without true levator ptosis[3] |
| Q10.0-Q10.3 | Congenital eyelid malformations | Congenital ptosis/blepharophimosis spectrum[4][5] |
...
- It **does not map** to CMS-HCC or Rx-HCC models and will not affect RAF scores in Medicare Advantage.[4][5]
- However, in ophthalmology/oculoplastics, it is significant for **medical necessity** of functional eyelid surgery rather than cosmetic procedures.[4][9]
...
Strong documentation should include:[2][3][4]
...
- **“Congenital ptosis”** documented but H02.402 used → should be Q10.x (Excludes1 conflict).[4][5]
- Chart clearly says **“mechanical ptosis due to dermatochalasis”** but coded as unspecified H02.402 instead of H02.412.[4][7]
...
- Lack of visual field testing or photographs where payer policy requires them for surgery approval.[4][9]
...
- Use **H02.402** when the note does **not specify** mechanical/myogenic/paralytic cause, even if you suspect one clinically.[4][6]
- If the surgeon or ophthalmologist explicitly documents **“mechanical ptosis from dermatochalasis”** or **“myogenic ptosis due to MG”**, upgrade to **H02.412/H02.422** as appropriate.[4][7]
- For functional surgery coverage:
  - Document **visual field loss**, **MRD1**, functional complaints, and **improvement with lid elevation**.
  - Attach **visual fields and pre-op photos** per payer policy.[4][9]
