...
> **Coding Tip:** While H59.031 itself generates no HCC weight, **underlying conditions** such as diabetes mellitus with complications (E11.3- series, which may map to HCCs) should be captured when documented and treated.​
...
> **Global Surgery Note:** Intravitreal injections (67028) carry a **10-day global period**. If the injection is performed for CME within the global period of the original cataract surgery, modifier **[[-78]]** (unplanned return to OR/procedure room) or **-58** (staged/related procedure) may be required depending on circumstances.​
