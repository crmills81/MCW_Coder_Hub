...
staging_system: N/A — Stage not documented or determinable
specialty:
  - Ophthalmology
  - Retina and Vitreous
...
risk_adjustment_note: |
  H35.3110 carries no HCC weight under CMS-HCC v28. Beyond the direct RAF impact (zero), use of H35.3110 when a stage-specific code is clinically supportable represents a documentation integrity gap. Accurate staging supports the complete clinical picture, which enables appropriate associated comorbidity documentation (vision impairment codes for advanced stages, AREDS2 compliance documentation for intermediate) that can influence quality metrics and downstream risk adjustment accuracy. CDI query investment to determine AMD stage is always worth the effort.
