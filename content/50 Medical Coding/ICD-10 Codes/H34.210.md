...
tags:
  ...
  - ICD-10-CM
code: H34.210
description: Branch retinal artery occlusion, unspecified eye
category: Diseases of the Eye and Adnexa
chapter: Chapter 7 (H00-H59)
block: Disorders of choroid and retina (H30-H36)
subcategory: Retinal vascular occlusions (H34.2)
specialty: Ophthalmology, Retina Specialist, Optometry, Internal Medicine, Emergency Medicine, Primary Care, Neurology
hcc_status: No
...
| **Subcategory** | `H34.2` | Other retinal artery occlusions |
| **Extension** | `H34.21` | Branch retinal artery occlusion |
| **Laterality** | `0` | Unspecified eye |

### Laterality Specifics
*   **0**: Unspecified eye ([[H34.210]])
*   **1**: Right eye ([[H34.211]])
*   **2**: Left eye ([[H34.212]])
*   **3**: Bilateral ([[H34.213]])
...
**Scenario:** A patient presents to the ER with sudden vision loss. Exam confirms BRAO, but documentation does not specify which eye before claim submission.
**Coding:**
*   Primary: [[H34.210]]
*   *Note:* Query the provider to clarify laterality if possible before claim submission.

### Example 2: Embolic Source Known
**Scenario:** Patient diagnosed with BRAO in the right eye due to atrial fibrillation.
**Coding:**
...
**Scenario:** Patient has retinal infarction due to occlusion of the precerebral artery.
**Coding:**
...
**Scenario:** Patient with BRAO in the left eye has severe vision impairment in that eye.
**Coding:**
*   Primary: [[H34.212]]
...
Management of [[H34.210]] typically involves <sup>American Academy of Ophthalmology</sup>:
