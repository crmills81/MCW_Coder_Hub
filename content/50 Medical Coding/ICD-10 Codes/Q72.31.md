...
risk_adjustment_note: |
  This code does not map directly to a payment HCC category under the adult CMS-HCC v28 model. While acquired absences of the foot (e.g., Z89.431) map to HCC 189 (Amputation Status), congenital absences often fall under specific pediatric or Medicaid risk adjustment models (CDPS) rather than standard Medicare models. Coders should capture it annually when it impacts care planning, prosthetic management, or physical therapy resources.
...
ncci_notes: |
  In the outpatient or profee setting, evaluation and management (E/M) visits dedicated to evaluating the pediatric patient for prosthetic fitting or monitoring musculoskeletal development due to the limb absence are separately billable from the actual fabrication/fitting codes billed by the prosthetist.
