...
tags:
  ...
  - ICD-10-CM
code: E11.3412
description: Type 2 diabetes mellitus with severe nonproliferative diabetic retinopathy with macular edema, left eye
...
*   **Moderate Retinopathy:** If the retinopathy is moderate, codes from the `.33` series are required (e.g., [[E11.3312]]).
*   **Proliferative Retinopathy:** If the retinopathy is proliferative, codes from the `.35` series are required (e.g., [[E11.3512]]).
...
**Scenario:** A patient with known Type 2 diabetes presents for a routine retina follow-up. Dilated exam reveals severe nonproliferative diabetic retinopathy with macular edema in the left eye. Right eye shows moderate NPDR without edema.
**Coding:**
...
**Scenario:** Patient previously coded with [[E11.3412]] returns. Exam now shows proliferative diabetic retinopathy in the left eye with macular edema.
**Coding:**
...
**Scenario:** Patient with Type 2 diabetes coded as [[E11.3412]] is on long-term insulin therapy.
**Coding:**
*   Primary: [[E11.3412]]
