...
> **OCT Bilateral Billing Note:** When OCT (92134) is performed bilaterally, confirm payer policy on whether to bill with modifier [[-50]] (bilateral procedure) or bill each unit separately. CMS typically accepts bilateral reporting for SCODI. Document both eyes explicitly in the interpretation report.
