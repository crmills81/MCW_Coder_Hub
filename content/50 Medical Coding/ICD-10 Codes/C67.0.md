...
# 🧬ICD-10 CM C67.0 - Malignant Neoplasm of Trigone of Bladder
...
### Definition
**ICD-10 CM [[C67.0]]** represents a primary malignant neoplasm specifically located at the **trigone of the bladder**. The trigone is a triangular area at the base of the bladder formed by the two ureteral orifices and the internal urethral orifice.
...
- Diagnostic codes decreased from **9,797 to 7,770 code**s
- Malignant neoplasm codes generally map to cancer-related **HCC categories**
- **Important:** Specific **HCC mapping** should be verified with current **CMS V28 crosswal**k files
