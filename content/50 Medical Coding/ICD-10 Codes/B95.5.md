...
- **[[A40.9]] - Streptococcal sepsis, unspecified**: A comprehensive combination code utilized for patients presenting with confirmed systemic inflammatory response syndrome (SIRS) driven by an unspecified streptococcal pathogen; sepsis due to unspecified streptococcus routes to this code via the A40 category, and specific sepsis combination codes preclude the concurrent use of B-series etiology codes.
...
- **Excludes1** (Mutually Exclusive - Cannot be coded together):
  ...
  - Sepsis due to unspecified streptococcus (**[[A40.9]]**)
