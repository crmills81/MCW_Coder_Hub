...
# 🧬ICD-10 CM H30.001 - Focal chorioretinal inflammation, right eye
>
## Overview
**ICD-10 CM [[H30.001]]** classifies **Focal chorioretinal inflammation** localized to the **right eye**. This condition involves inflammation of both the choroid (**the vascular layer of the eye**) and the retina in a specific, limited area (**focal**) rather than being disseminated or widespread. It is a form of posterior uveitis.

Accurate coding of [[H30.001]] is essential for documenting ocular inflammation, tracking disease progression, and supporting medical necessity for diagnostic imaging (e.g., OCT, Fluorescein Angiography) and treatments (**e.g., corticosteroids, immunosuppressive therapy**). Laterality must be specified whenever possible.

## Code Breakdown
The structure of [[H30.001]] follows the ICD-10-CM taxonomy:
...
> **ICD-10-CM guidelines** emphasize specifying laterality for eye conditions whenever known. If the medical record indicates the right eye is affected, use [[H30.001]]. If bilateral, use [[H30.003]]. Avoid unspecified codes ([[H30.009]]) when clinical documentation supports specificity.
...
[[H30.001]] may be coded with additional codes to fully capture the clinical picture:
...
In the inpatient setting, [[H30.001]] influences the Medicare Severity Diagnosis Related Group (MS-DRG) assignment.
...
**Scenario:** A patient presents for follow-up of known focal [[chorioretinitis]] in the right eye. The inflammation is stable on current medication.
**Coding:**
*   Primary: [[H30.001]]
*   Secondary: [[Z79.52]] (Long term (current) use of steroids) - *If applicable.*

### Example 2: Associated with Sarcoidosis
**Scenario:** Patient with systemic sarcoidosis presents with flare-up of focal chorioretinal inflammation in the right eye.
**Coding:**
*   Primary: [[D86.9]] ([[Sarcoidosis]], unspecified) - *If managing the systemic condition.*
*   Secondary: [[H30.001]] (Focal chorioretinal inflammation, right eye)
*   *Note:* Sequence based on the reason for the encounter. If the visit is solely for the eye, [[H30.001]] may be primary.

### Example 3: Infectious Etiology
**Scenario:** Patient diagnosed with focal chorioretinitis in the right eye due to Toxoplasmosis.
**Coding:**
*   Primary: [[B58.01]] (Toxoplasma chorioretinitis)
*   *Note:* Do not use [[H30.001]] when a specific etiology code exists that includes the eye condition. [[B58.01]] is more specific.
...
*   **Prior Authorization:** Medications used to treat chorioretinitis (e.g., biologics, steroids) and imaging (e.g., [[92201]] for Angiography) often require prior authorization supported by diagnosis codes like [[H30.001]].
...
Management of [[H30.001]] typically involves <sup>American Academy of Ophthalmology</sup>:
