...
observation: -"Spontaneous resolution of VMA/VMT occurs in approximately 30% of cases within 1-2 years — observation is appropriate first-line management for many patients." - "Specify laterality — left, right, or bilateral. Never default to H43.829 (unspecified) when the affected eye is documented." - "Distinguish between VMA (adhesion without macular morphologic change) and VMT (traction with documented retinal distortion, pseudocyst, or macular hole formation) in the clinical note — both map to H43.822 but the clinical distinction drives treatment decisions." - "Document OCT findings explicitly — describe the vitreomacular attachment zone diameter, presence or absence of foveal distortion, pseudocyst formation, intraretinal cysts, and retinal surface contour." - "Document visual symptoms — decreased visual acuity, metamorphopsia (wavy/distorted lines), central scotoma, micropsia." - "Document the adhesion size on OCT — focal VMA (less than or equal to 1500 micrometers) vs. broad VMA (greater than 1500 micrometers) per IVTS classification, as this influences pharmacologic eligibility and surgical planning." - "Document concurrent findings — epiretinal membrane (code separately H35.37x), lamellar hole (H35.34x), full-thickness macular hole (H35.32x), or concurrent PVD (H43.812)." - "Document functional impact on visual acuity, reading ability, and ADLs to support medical necessity for intervention." - "If observation is chosen, document rationale and planned follow-up schedule."
