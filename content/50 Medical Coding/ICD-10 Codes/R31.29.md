...
2. **Not otherwise classified** as asymptomatic (R31.21) or benign essential (R31.1)
...
**Pathophysiology:**
RBCs enter urine from anywhere in urinary tract (kidneys, ureters, bladder, urethra, prostate) → detected by dipstick (heme-positive) or microscopy (elevated RBC count) → not visible to eye but clinically significant.
...
1. **Has symptoms OR does not fit asymptomatic criteria:**
   - Patient has urinary symptoms (dysuria, frequency, urgency, pain, etc.)
...
1. **Cause is unknown OR documented separately:**
