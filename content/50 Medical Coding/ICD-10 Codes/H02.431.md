...
1. **Cause is documented or evident as NEUROGENIC/PARALYTIC:**
...
1. **RIGHT EYELID is specified as affected** (not left, not bilateral, not unspecified)

2. **More specific etiology may or may not be documented**, but neurogenic mechanism is clear
