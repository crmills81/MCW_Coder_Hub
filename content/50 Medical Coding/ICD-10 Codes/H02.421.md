...
| Element | Value |
|---|---|
| **ICD-10-CM code** | **H02.421** <small>[web:937][web:1014]</small> |
| **Official descriptor** | Myogenic ptosis of right eyelid <small>[web:937][web:1014]</small> |
| **Parent category** | H02.42 – Myogenic ptosis of eyelid <small>[web:932]</small> |
| **ICD-10-CM chapter** | H00–H59 (Diseases of the eye and adnexa) → H00–H05 (Disorders of eyelid, lacrimal system and orbit) → H02 (Other disorders of eyelid) <small>[web:937][web:1014]</small> |
| **Laterality** | Right eyelid (OD) <small>[web:937]</small> |
| **Billable** | ✓ Yes (laterality-specific terminal code) <small>[web:937]</small> |
| **Excludes1** | Congenital malformations of eyelid (Q10.0–Q10.3) <small>[web:932][web:937]</small> |
| **Clinical mechanism** | Primary weakness/dysfunction of levator palpebrae superioris muscle and/or Müller's smooth muscle <small>[web:831][web:928]</small> |
| **HCC status** | Not a CMS-HCC code; underlying etiology (e.g., myasthenia gravis) may be HCC-relevant <small>[web:1021][web:1023]</small> |
| **Payer relevance** | Listed in CMS billing/coding articles for functional ptosis repair and nerve conduction studies <small>[web:949][web:1018]</small> |

---

## Short description

**H02.421** codes **myogenic ptosis of the right eyelid** – drooping of the right upper eyelid caused by **primary muscle weakness or dysfunction** of the levator palpebrae superioris (main elevator muscle) and/or Müller's smooth muscle, rather than mechanical obstruction, nerve damage, or aponeurotic defects. <small>[web:937][web:928][web:831]</small>

Use H02.421 when provider documentation explicitly supports **myogenic/muscle-based** etiology and specifies **right eyelid**. <small>[web:937][web:932]</small>
