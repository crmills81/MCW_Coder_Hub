---
tags: [ICD-10-CM, ENT, otolaryngology, vocal-cord, larynx, polyp, J38-1, hoarseness, voice-disorder]
code: J38.1
...
**J38.1** is used for **polyp of the vocal cord and/or larynx** – benign, non-neoplastic growths arising from the mucous membrane of the vocal cords or other laryngeal structures.[web:434][web:436][web:437] This code applies when a polyp (typically pedunculated or sessile) is diagnosed on the true vocal cords, false vocal cords, or other parts of the larynx.[web:436][web:440]

**Key points:** This is a **billable, specific diagnosis code** without laterality specification, used for benign polypoid lesions of the larynx that commonly cause hoarseness and voice changes.[web:434][web:441]

---

## Full Description & Clinical Context

**Vocal cord and laryngeal polyps** are benign, localized, non-neoplastic growths that arise from the lamina propria of the vocal fold or other laryngeal mucosa.[web:436][web:440] They are typically caused by chronic voice abuse, smoking, reflux, or acute vocal trauma (such as screaming or prolonged phonation).[web:436]

**J38.1 applies when:**[web:434][web:436][web:437]
...
**Clinical presentation:**[web:436][web:440]
...
**Pathophysiology:**[web:436][web:440]
...
- **Code set:** ICD-10-CM
- **Full code:** J38.1
- **Description:** Polyp of vocal cord and larynx[web:434][web:437][web:439]
- **Parent code:** J38 – Diseases of vocal cords and larynx, not elsewhere classified[web:434]
- **Code type:** Billable/specific diagnosis code[web:441]
- **Specificity:** Does NOT specify laterality (right vs left vocal cord)[web:436]

**Excludes at J38 category:**[web:434]
...
**J38 includes various benign and functional vocal cord/laryngeal conditions:**[web:434][web:437]
...
| **J38.1** | **Polyp of vocal cord and larynx** | **Benign polyp, any laryngeal location**[web:434][web:437] ← YOU ARE HERE |
| J38.2 | Nodules of vocal cords | Bilateral nodules (singer's/screamer's nodules)[web:438] |
...
**Key distinction:** J38.1 is for **polyps** (focal growths); J38.2 is for **nodules** (typically bilateral, callous-like thickenings).[web:438]
...
| **Laterality** | Usually **unilateral** | Typically **bilateral** (singer's nodules)[web:438] |
...
**Coding rule:** If documentation says "polyp" → use **J38.1**. If "nodules" or "singer's nodules" → use **J38.2**.[web:438]
...
|-----------|------|-------------|
| **Benign polyp of vocal cord/larynx** | **J38.1** | Confirmed benign polyp[web:434][web:436] ← YOU ARE HERE |
...
**Rule:** If pathology or clinical suspicion suggests **malignancy or neoplasm**, use D14.1, C32.x, D02.0, or D38.0 – NOT J38.1.[web:438]

---

## When to Use J38.1

Use **J38.1** when **ALL** of the following are true:[web:434][web:436][web:437]
...
|----------|-------------|-----|
| **Bilateral vocal cord nodules** | **J38.2** | Nodules, not polyps[web:438] |
| **Benign neoplasm (papilloma, etc.)** | **D14.1** | True neoplasm, not simple polyp[web:438] |
...
**MINIMUM documentation to support J38.1:**[web:434][web:436]
...
**Note:** No risk adjustment implications for Medicare Advantage or other value-based models.
...
- **31575** – Laryngoscopy, flexible; diagnostic[web:442]
...
- **R49.0** – Dysphonia (hoarseness) – PRIMARY SYMPTOM[web:436][web:440]
