...
# 🧬 ICD-10 CM H34.12 - Central retinal artery occlusion, left eye
>
## Overview
**ICD-10 CM [[H34.12]]** classifies **Central retinal artery occlusion (CRAO)**, specifically localized to the **left eye**. CRAO is a serious ophthalmic emergency often referred to as an "**eye stroke**," caused by a blockage of the central retinal artery which supplies blood to the inner layers of the retina. This condition typically results in sudden, painless, severe vision loss in the affected eye.

Accurate coding of [[H34.12]] is critical for documenting vision-threatening conditions, supporting medical necessity for urgent interventions (**e.g., ocular massage, anterior chamber [[paracentesis]], lowering intraocular pressure**), and tracking outcomes. Laterality must be specified whenever possible to distinguish from unspecified ([[H34.10]]) or right eye ([[H34.11]]) cases.

## Code Breakdown
The structure of [[H34.12]] follows the ICD-10-CM taxonomy:

| Segment | Value | Description |
| :--- | :--- | :--- |
| **Category** | `H34` | Retinal vascular occlusions |
| **Subcategory** | `H34.1` | Central retinal artery occlusion |
| **Extension** | `2` | Left eye |
...
> **ICD-10-CM guidelines** emphasize specifying laterality for eye conditions whenever known. If the medical record indicates the left eye is affected, use [[H34.12]]. If **bilateral**, use [[H34.13]]. Avoid unspecified codes ([[H34.10]]) when clinical documentation supports specificity.
...
[[H34.12]] may be coded with additional codes to fully capture the clinical picture:
...
In the inpatient setting, [[H34.12]] influences the Medicare Severity Diagnosis Related Group (MS-DRG) assignment.
...
### Example 1: Specific Laterality
**Scenario:** A patient presents to the ER with sudden vision loss. Exam confirms CRAO in the left eye.
**Coding:**
*   Primary: [[H34.12]]
*   *Note:* Use specific laterality code [[H34.12]] instead of [[H34.10]] when documented.

### Example 2: Embolic Source Known
**Scenario:** Patient diagnosed with CRAO in the left eye due to atrial fibrillation.
**Coding:**
*   Primary: [[H34.12]] (Central retinal artery occlusion, left eye)
*   Secondary: [[I48.91]] (Unspecified atrial fibrillation)
*   *Note:* Code both the manifestation and the underlying etiology.

### Example 3: Precerebral Artery Occlusion
**Scenario:** Patient has retinal infarction due to occlusion of the left precerebral artery.
**Coding:**
*   Primary: [[I65.1]] (Occlusion and stenosis of basilar artery) - *Example of precerebral code.*
*   Secondary: [[H34.12]] (If applicable per Excludes1 note guidance, often I65.1 takes precedence for the infarction etiology).
...
*   **Prior Authorization:** Urgent interventions (e.g., [[65810]] for Paracentesis of anterior chamber) often require prior authorization supported by diagnosis codes like [[H34.12]] documenting the occlusion.
...
Management of [[H34.12]] typically involves <sup>American Academy of Ophthalmology</sup>:
...
Common diagnostic tests that support [[H34.12]] include:
