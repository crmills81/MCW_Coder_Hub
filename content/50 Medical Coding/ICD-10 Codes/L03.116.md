---
title: "ICD-10 L03.116: Cellulitis of Left Lower Limb"
aliases: 
  - "L03.116"
  - "Cellulitis left leg"
...
**Common causative organisms[2][3]:**
...
**Clinical diagnosis** is standard; additional testing is supportive but not always required[2]:
...
**Laboratory/Imaging (when indicated):[2][3]**
...
**Audit tip:** Cellulitis is primarily clinical; culture/imaging helpful but not required to support diagnosis.
...
**General principle:** Initiate empiric antibiotics ASAP; tailor based on culture/sensitivities if available[2][3].
