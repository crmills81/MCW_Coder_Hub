...
alphabet:
  - M
definition: Excessive or pathologic constriction of the pupil of the eye, reducing its diameter, caused by drugs, neurological disease, or physiologic reflex stimulation.
---

>[!Note] DEFINITION of [[miosis]]
...
>[!info]+ ETYMOLOGY of [[miosis]]
>#greek
>
>|Component|Origin|Meaning|
>|---|---|---|
>|**[[mio-]]** / **[[myo-]]**|Greek _μύειν_ (múein)|"**to close**," "**to be closed (of the eyes)**" — directional/action prefix describing the closing or narrowing motion|
>|**[[-osis]]**|Greek _-ōsis_ (-ōsis), from _-o-_ (stem vowel) + _-sis_ (action noun suffix)|Noun-forming suffix — "**process, condition, or abnormal state of**"|
>
...
> 
> - **Miotic** _(adjective form — clinical collocations: "miotic pupil," "miotic agent," "miotic drop")_
> - **Myosis / myotic** _(variant spelling accepted in ICD index — coded identically to miosis under [[H57.03]]; used interchangeably in older literature)_
> - **Pinpoint pupil** _(lay/clinical term; especially used in emergency and toxicology settings to describe opioid-induced or pontine-hemorrhage miosis; < 1 mm diameter)_
> - **Pupillary constriction** _(clinical descriptor synonym used in neurology and anesthesia documentation; coded under [[H57.03]] when pathologic)_
> - **[[Horner syndrome]] miosis** _(partial miosis 1–2 mm; combined with ptosis and anhidrosis; caused by sympathetic chain disruption — distinguished from parasympathetic-driven miosis by its partial degree and associated features)_
> - **Drug-induced miosis** _(caused by cholinergic agents — pilocarpine, opioids, organophosphates; common in glaucoma treatment and toxicology; coded [[H57.03]] with additional T-code for substance when toxic)_
> - **Physiologic miosis** _(normal light-reflex constriction; not coded unless documented as pathologic or persistent)_
> - **[[H21.27]] Miotic cyst of pupillary margin** _(distinct entity — a cyst at the pupillary margin caused by miotic drops, not the reflex itself; has its own ICD-10-CM code)_
...
> 
> #### Miotic Cyst — Complication of Miotic Drug Therapy
> 
> |Code|Description|
> |---|---|
> |**[[H21.271]]**|Miotic cyst of pupillary margin, right eye|
> |**[[H21.272]]**|Miotic cyst of pupillary margin, left eye|
> |**[[H21.273]]**|Miotic cyst of pupillary margin, bilateral|
> |**[[H21.279]]**|Miotic cyst of pupillary margin, unspecified eye|
> 
> #### Toxic / Drug-Induced Miosis — External Cause Codes (Sequence After H57.03)
> 
> |Code|Description|
> |---|---|
...
> |**[[T44.1X1A]]**|Poisoning by parasympathomimetics (cholinergics), accidental, initial encounter|
> |**[[T60.0X1A]]**|Toxic effects of organophosphate and carbamate insecticides, accidental, initial encounter|
> 
> #### Horner Syndrome — Sympathetic-Mediated Miosis
> 
> |Code|Description|
> |---|---|
...
> ---
> 
> ### 🔧 COMMON CPT CODES (Miosis-Related Diagnosis & Treatment)
> 
...
> |**[[92060]]**|Sensorimotor examination with multiple measurements of ocular deviation (e.g., by prism/cover test) with interpretation and report (used when cranial nerve involvement with miosis is evaluated)|
> |**[[92081]]**|Visual field examination, unilateral or bilateral, with interpretation and report; limited examination (e.g., tangent screen, Autoplot, arc perimeter, or single stimulus level automated test)|
> |**[[92082]]**|Visual field examination, unilateral or bilateral, with interpretation and report; intermediate examination|
> |**[[92083]]**|Visual field examination, unilateral or bilateral, with interpretation and report; extended examination (threshold or suprathreshold automated testing)|
> |**[[92132]]**|Computerized ophthalmic diagnostic imaging, anterior segment, with interpretation and report, unilateral or bilateral (used to assess iris and anterior chamber in chronic miosis)|
> |**[[92285]]**|External ocular photography with interpretation and report for documentation of medical progress (e.g., iris, anterior segment conditions including miotic pupil documentation)|
> |**[[99213]]**|Office or other outpatient visit, established patient, low-to-moderate medical decision making (used when miosis is evaluated in a medical/neurologic context outside ophthalmology)|
> 
> ---
> 
...
>[!tip]- DERIVATIONS of [[miosis]]
>```dataview
>TABLE definition AS Definition
>FROM #medterm 
>WHERE length(filter(roots, (word) => econtains([[miosis]].roots, word))) > 0 AND file.name != [[miosis]].file.name
>SORT file.name ASC
>```
...
>TABLE definition AS Definition
>FROM #medterm 
>WHERE length(filter(definition, (word) => econtains([[miosis]].definition, word))) > 0 AND file.name != [[miosis]].file.name
>```
