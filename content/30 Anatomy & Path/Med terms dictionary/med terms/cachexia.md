...
alphabet: C
definition:
  - A multifactorial wasting syndrome of progressive skeletal muscle loss (with or without fat loss), driven by underlying disease and systemic inflammation, that cannot be fully reversed by nutritional support alone
---
>[!Note] DEFINITION of [[cachexia]]
...
_____
>[!info]+ ETYMOLOGY of [[cachexia]]
>#greek
>
>|Component|Origin|Meaning|
>|---|---|---|
>|**[[cac-]]** / **kak-**|Greek _κακός_ (kakós)|"**Bad**," "**evil**," "**poor**" — the universal Greek pejorative prefix; opposite of *eu-* ("good")|
>|**[[-hexia]]** / **hexis**|Greek _ἕξις_ (héxis), from _ἔχειν_ (ékhein)|"**Condition**," "**state of being**," "**bodily habit**" — from "to have, to hold"; referring to one's overall physical state/constitution|
>
...
> - **Cardiac cachexia** _(cachexia in CHF — I50.x + E88.A or R64; strongly associated with mortality in heart failure)_
> - **Renal cachexia** _(CKD/ESRD-associated wasting; N18.x + E88.A)_
> - **Refractory cachexia** _(terminal/end-stage cachexia; not responsive to any intervention; coded with underlying condition)_
> - **Pre-cachexia** _(early stage with metabolic changes but <5% weight loss; not separately coded; map to R63.4 or underlying condition)_
> - **HIV wasting syndrome** _(B22.2 — AIDS-defining condition; listed separately in ICD-10-CM Chapter 1)_
> - **Anorexia-cachexia syndrome** _(combined term used in oncology/palliative medicine; anorexia + muscle wasting + metabolic dysregulation)_
> 
_____
...
> ### 🏥 ICD-10-CM CODES
> 
> #### **Primary Cachexia Codes**
> 
> |Code|Description|
> |---|---|
> |[[R64]]|Cachexia — **Excludes1: E41 (nutritional marasmus), E88.A (cachexia due to underlying condition), R63.4 (abnormal weight loss)**; use when cachexia is not attributable to a specified underlying condition|
> |[[E88.A]]|Disease-associated cachexia _(FY2024 addition — use when cachexia is directly attributable to cancer, CHF, CKD, COPD, HIV, or other documented chronic condition; more specific than R64)_|
> 
> #### **HIV/AIDS-Associated Wasting (Distinct Code)**
> 
> |Code|Description|
> |---|---|
> |[[B22.2]]|HIV disease resulting in wasting syndrome _(AIDS wasting syndrome — coded directly here, NOT R64 or E88.A)_|
> 
> #### **Malnutrition Codes (Frequently Co-Coded or Confused with Cachexia)**
> 
> |Code|Description|
> |---|---|
> |[[E41]]|Nutritional marasmus _(severe caloric malnutrition — Excludes1 from R64; NOT cachexia)_|
> |[[E43]]|Unspecified severe protein-calorie malnutrition _(Kwashiorkor + marasmus combined)_|
> |[[E44.0]]|Moderate protein-calorie malnutrition|
> |[[E44.1]]|Mild protein-calorie malnutrition|
> |[[E45]]|Retarded development following protein-calorie malnutrition|
> |[[E46]]|Unspecified protein-calorie malnutrition|
> 
> #### **Weight Loss / Anorexia — Symptom Codes (Supporting)**
> 
> |Code|Description|
> |---|---|
> |[[R63.0]]|Anorexia _(loss of appetite — accompanies cachexia; separately codeable as symptom)_|
> |[[R63.4]]|Abnormal weight loss _(Excludes1 from R64 — do NOT code R63.4 with R64 simultaneously)_|
> |[[R53.83]]|Other fatigue _(cancer fatigue / cachexia-related exhaustion — separately codeable)_|
> 
> #### **Common Underlying Conditions Driving Cachexia**
> 
> |Code|Description|
> |---|---|
> |[[C80.1]]|Malignant (primary) neoplasm, unspecified _(sequence underlying malignancy before E88.A)_|
> |[[I50.9]]|Heart failure, unspecified _(cardiac cachexia — sequence I50.x before E88.A)_|
> |[[N18.6]]|End-stage renal disease _(renal cachexia — sequence N18.x before E88.A)_|
> |[[J44.1]]|COPD with acute exacerbation _(COPD cachexia — sequence J44.x before E88.A)_|
> |[[B20]]|Human immunodeficiency virus (HIV) disease _(AIDS cachexia — use B22.2 for wasting specifically)_|
> 
> ---
> 
> ### 🔧 COMMON CPT CODES (Cachexia Assessment & Management)
> 
> |CPT Code|Description|
> |---|---|
> |**[[82040]]**|Albumin; serum, plasma, or whole blood _(low albumin reflects inflammation — not a nutritional marker per ASPEN 2012, but still widely ordered)_|
> |**[[84134]]**|Prealbumin (transthyretin) _(same caveat as albumin — reflects acute phase response, not nutrition; still commonly used)_|
> |**[[86140]]**|C-Reactive Protein (CRP) _(distinguishes inflammatory from non-inflammatory wasting; elevated in true cachexia)_|
> |**[[80053]]**|Comprehensive metabolic panel _(baseline metabolic assessment in cachectic patients)_|
> |**[[97802]]**|Medical nutrition therapy; initial assessment and intervention, individual, face-to-face with RD; 15 min|
> |**[[97803]]**|Medical nutrition therapy; reassessment and intervention, individual, face-to-face with RD; 15 min|
> |**[[97750]]**|Physical performance test or measurement, with written report; 15 min _(functional capacity/muscle strength assessment)_|
> |**[[97110]]**|Therapeutic exercises; 15 min _(resistance training — only partially effective in cachexia vs. sarcopenia; combined with nutritional support)_|
> |**[[99497]]**|Advance care planning; first 30 min _(palliative discussions in refractory cachexia — common in late-stage cancer admissions)_|
> 
> ---
> 
