...
forms:
  ...
  - inflammation
alphabet: V
definition: A broad group of autoimmune and inflammatory conditions characterized by the inflammation and subsequent damage of blood vessel walls, which can lead to vessel narrowing, occlusion, aneurysm, or rupture, compromising blood flow to tissues and organs.
---
>[!Note] DEFINITION of [[vasculitis]]
...
_____
>[!info]+ ETYMOLOGY of [[vasculitis]]
>#latin #greek
>
>|Component|Origin|Meaning|
>|---|---|---|
>|**[[vascul-]]**|Latin _vasculum_ (diminutive of _vas_)|"**Small vessel / blood vessel**" — referring to the anatomical structures that carry blood throughout the body; appears in [[vascular]], [[cardiovascular]], [[vasculopathy]]|
>|**[[-itis]]**|Ancient Greek _-ῖτις_ (-îtis)|"**Inflammation of / disease of**" — the universal medical suffix for inflammatory processes; appears in [[arthritis]], [[dermatitis]], [[appendicitis]]|
>
> **Literally**: _"Inflammation of a blood vessel."_ The term is synonymous with **angiitis** (from the Greek *angeion*, meaning vessel), though *vasculitis* is the overwhelmingly preferred term in modern clinical and diagnostic classifications (**such as the Chapel Hill Consensus Conference definitions**). When specifying the type of vessel, terms like **arteritis** (**arteries**) and **venulitis** or **phlebitis** (**veins**) are utilized.
_____

> [!success]+ ### 🔀 ALIASES / ALTERNATE TERMS
>
> - **Angiitis** *(direct synonym; literally "vessel inflammation")*
...
> ### 🏥 ICD-10-CM CODES
>
> #### **Vasculitis — Category M30-M31 (Systemic) & I77 / L95 (Localized)**
...
>
> ##### Systemic Necrotizing Vasculopathies
>
> |Code|Description|
> |---|---|
> |**[[M31.9]]**|Necrotizing vasculopathy, unspecified *(Use for systemic vasculitis NOS)*|
> |**[[M31.6]]**|Other giant cell arteritis *(Standard code for GCA/temporal arteritis without PMR)*|
> |**[[M31.5]]**|Giant cell arteritis with polymyalgia rheumatica *(Combination code required when both GCA and PMR are documented)*|
> |**[[M31.30]]**|Wegener's granulomatosis without renal involvement *(GPA without kidney involvement)*|
> |**[[M31.31]]**|Wegener's [[granulomatosis]] with renal involvement *(Requires provider documentation linking kidney dysfunction/glomerulonephritis to the GPA)*|
> |**[[M30.0]]**|Polyarteritis nodosa|
> |**[[M30.3]]**|Mucocutaneous lymph node syndrome [Kawasaki]|
> |**[[M30.1]]**|Polyarteritis with lung involvement [Churg-Strauss] *(Eosinophilic granulomatosis with polyangiitis / EGPA)*|
>
> ##### Skin-Limited & Unspecified Vessel Vasculitis
>
> |Code|Description|
> |---|---|
> |**[[L95.9]]**|Vasculitis limited to skin, unspecified *(Use for cutaneous/leukocytoclastic vasculitis without systemic involvement)*|
> |**[[I77.6]]**|Arteritis, unspecified *(Non-specific inflammation of an artery, not systemic)*|
> |**[[I80.9]]**|[[Phlebitis]] and [[thrombophlebitis]] of unspecified site *(Inflammation of a vein)*|
>
> ---
>
> ### 🔧 COMMON CPT CODES (Diagnostics & Biopsies)
>
> #### Surgical Biopsies
> *(Tissue biopsy remains the gold standard for definitively diagnosing many forms of vasculitis.)*
>
> |CPT Code|Description|
> |---|---|
> |**[[37609]]**|Ligation or biopsy, temporal artery *(The definitive diagnostic procedure for Giant Cell Arteritis / Temporal Arteritis)*|
> |**[[11102]]**|Tangential biopsy of skin (eg, shave, scoop, saucerize, curette); single lesion *(Commonly used to biopsy palpable purpura to confirm leukocytoclastic small-vessel vasculitis)*|
> |**[[11104]]**|Punch biopsy of skin (including simple closure); single lesion|
> |**[[31237]]**|Nasal/sinus endoscopy, surgical; with biopsy, polypectomy or [[debridement]] *(Commonly used to biopsy inflamed sinus tissue in suspected GPA/Wegener's)*|
>
> #### Laboratory Testing (Immunology)
>
> |CPT Code|Description|
> |---|---|
> |**[[86021]]**|Antibody identification; leukocyte antibodies *(Used for ANCA testing, vital for diagnosing GPA, MPA, and EGPA)*|
> |**[[85651]]**|Sedimentation rate, erythrocyte; non-automated *(ESR - standard inflammatory marker)*|
> |**[[86140]]**|C-reactive protein *(CRP - acute phase reactant monitoring)*|
> |**[[88305]]**|Level IV - Surgical pathology, gross and microscopic examination *(Billed by the pathologist reviewing the skin/temporal artery biopsy for immune infiltration)*|
>
> #### Modifiers Commonly Used
>
> |Modifier|Usage|
> |---|---|
> |**[[-RT]]** / **[[-LT]]**|Right side / Left side — Crucial for surgical biopsies like temporal artery biopsy (**[[37609]]**) to specify the anatomical side sampled.|
> |**[[-50]]**|Bilateral procedure — Used if bilateral temporal artery biopsies are performed during the same operative session to maximize the chance of capturing a "**skip lesion**".|
...
>
_____
>[!tip]- DERIVATIONS of [[vasculitis]]
>```dataview
>TABLE definition AS Definition
>FROM #medterm
>WHERE length(filter(roots, (word) => econtains([[vasculitis]].roots, word))) > 0 AND file.name != [[vasculitis]].file.name
>SORT file.name ASC
>```
_____
