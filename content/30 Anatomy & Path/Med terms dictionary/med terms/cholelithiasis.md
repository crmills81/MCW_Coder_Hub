...
alphabet:
  - C
definition: The presence of one or more calculi (stones) within the gallbladder or biliary tract,formed by precipitation of bile constituents including cholesterol,bilirubin,and calcium salts.
---

> [!Note] DEFINITION of [[cholelithiasis]]
...
> [!info]+ ETYMOLOGY of [[cholelithiasis]]
> #greek
>
...
> | **[[-iasis]]** | Greek *-ίασις* (-iasis, ee-AH-sis) | Noun-forming suffix — "**condition of**," "**pathological state characterized by**" — used in medicine to denote a disease state defined by the presence of something (**e.g., infestation, concretion, or organism**) |
>
...
>
> #### Closely Related Gallbladder & Biliary Codes (Frequently Coded with K80.xx)
>
> | Code | Description |
> |---|---|
> | **[[K81.0]]** | Acute cholecystitis (without gallstones — code only when stones are NOT documented; use K80.0x combination codes when stones ARE present) |
> | **[[K81.1]]** | Chronic cholecystitis (without stones — same rule applies; use K80.1x when stones are documented) |
> | **[[K81.9]]** | Cholecystitis, unspecified |
> | **[[K83.09]]** | Other cholangitis (used for cholangitis not captured in K80.3x combination codes, or when stones not confirmed) |
> | **[[K83.1]]** | Obstruction of bile duct (biliary obstruction without confirmed stones — e.g., stricture, external compression) |
> | **[[K82.8]]** | Other specified diseases of gallbladder (includes biliary dyskinesia and gallbladder sludge) |
...
> | **[[R17]]** | Unspecified jaundice (code as additional dx when obstructive jaundice is present and not integral to the primary code) |
>
> ---
>
...
> |---|---|
> | **[[76700]]** | Ultrasound, abdominal, real time with image documentation, complete (primary first-line imaging for gallstone detection) |
> | **[[76705]]** | Ultrasound, abdominal, real time with image documentation, limited (focused RUQ ultrasound for gallbladder evaluation) |
> | **[[74181]]** | MRI abdomen without contrast (MRCP protocol for biliary tree evaluation and choledocholithiasis detection) |
> | **[[74183]]** | MRI abdomen without and with contrast (MRCP with contrast for complex biliary anatomy or suspected mass) |
...
> | **[[43264]]** | ERCP with removal of calculi/debris from biliary and/or pancreatic ducts (therapeutic ERCP — stone extraction from CBD; primary treatment for choledocholithiasis) |
> | **[[43262]]** | ERCP with sphincterotomy/papillotomy (biliary sphincterotomy to facilitate stone passage or extraction) |
> | **[[47562]]** | Laparoscopic cholecystectomy (definitive surgical treatment for symptomatic cholelithiasis; most common elective general surgery procedure) |
> | **[[47563]]** | Laparoscopic cholecystectomy with intraoperative cholangiography (adds cholangiogram to assess for CBD stones intraoperatively — triggers query for choledocholithiasis if CBD stone found) |
> | **[[47564]]** | Laparoscopic cholecystectomy with exploration of common duct |
> | **[[47600]]** | Cholecystectomy, open (open approach; used in cases with complex anatomy, perforation, or failed laparoscopic approach) |
>
> ---
>
...
> [!tip]- DERIVATIONS of [[cholelithiasis]]
> ```dataview
> TABLE definition AS Definition
> FROM #medterm
> WHERE length(filter(roots, (word) => econtains([[Cholelithiasis]].roots, word))) > 0 AND file.name != [[Cholelithiasis]].file.name
> SORT file.name ASC
> ```
...
> TABLE definition AS Definition
> FROM #medterm
> WHERE length(filter(definition, (word) => econtains([[Cholelithiasis]].definition, word))) > 0 AND file.name != [[Cholelithiasis]].file.name
> ```
