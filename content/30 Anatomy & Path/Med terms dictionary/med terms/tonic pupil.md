...
alphabet:
  - T
definition: A tonic pupil is a pupil that constricts abnormally slowly and redilates even more slowly after light or near stimulation, caused by damage to the postganglionic parasympathetic fibers of the ciliary ganglion or short ciliary nerves, with subsequent aberrant reinnervation producing denervation supersensitivity and light-near dissociation.
---

> [!Note] DEFINITION of [[tonic pupil]]
...
> [!info]+ ETYMOLOGY of [[tonic pupil]]
> #greek #latin
>
> | Component | Origin | Meaning |
> |---|---|---|
> | **[[ton-]]** | Greek *τόνος* (TO-nos) → *τονικός* (to-ni-KOS), from PIE root *** *ten-*** ("to stretch") | "**a stretching**," "**tension**," "**tone**" — the physical sense of something stretched taut; extended in medicine to mean the sustained tension or firmness of a muscle or tissue |
> | **[[-ic]]** | Greek *-ικός* (-ikos) → Latin *-icus* → English *-ic* | Adjective-forming suffix — "**pertaining to**," "**of the nature of**," "**characterized by**" |
> | **[[pupill-]]** | Latin *pūpilla* (pyoo-PIL-ah), diminutive of *pūpa* ("girl," "doll") | "**little girl**," "**little doll**" — named for the tiny reflected image of a person seen when looking into another's eye; *pūpilla* also meant "female orphan ward" in Roman law, sharing the same etymological root as English *pupil* (student) |
> | **[[-a]]** | Latin feminine noun suffix | Noun-forming suffix for Latin feminine nouns of the first declension |
>
...
>
> - **Tonic** _(adjective form — appears in "tonic contraction," "tonic reflex," "tonic convergence reaction"; in neurology, "tonic" describes any sustained, slow-relaxing response, distinct from a phasic/rapid response)_
> - **Adie's pupil** _(eponymous clinical synonym — used interchangeably with tonic pupil in ophthalmology and neuro-ophthalmology; preferred when the cause is idiopathic/autoimmune)_
> - **Adie pupil** _(variant spelling without possessive apostrophe — increasingly preferred in modern publications per AMA style)_
> - **Holmes-Adie pupil** _(eponymous synonym emphasizing Gordon Holmes's contemporaneous description)_
> - **Adie's syndrome / Holmes-Adie syndrome** _(broader autonomic neuropathy syndrome: tonic pupil + diminished/absent deep tendon reflexes)_
> - **Pupillotonic pseudotabes** _(historical clinical term used before Adie's 1932 description; "pseudo-tabes" because the absent reflexes mimicked tabes dorsalis; no longer in common clinical use)_
> - **Myotonic pupil** _(older synonym emphasizing the prolonged, tonic quality of the iris sphincter response; rarely used in contemporary literature)_
> - **Light-near dissociation** _(core functional signature: markedly reduced light reflex with preserved, sluggish near response)_
> - **Denervation supersensitivity** _(pharmacologic hallmark: robust constriction to dilute pilocarpine 0.0625%-0.1% in the affected eye, confirming postganglionic parasympathetic denervation)_
> - **Sectoral palsy** _(slit-lamp finding of segmental vermiform iris sphincter contractions; pathognomonic for tonic pupil due to patchy aberrant reinnervation)_
> - **[[ciliary ganglion]]** _(the anatomical lesion site in classic tonic pupil; parasympathetic orbital relay ganglion receiving CN III input)_
> - **Ross syndrome** _(autonomic neuropathy triad: tonic pupil + progressive segmental anhidrosis + areflexia; expanded Holmes-Adie spectrum)_
...
>
> #### Other Pupillary Anomalies — Differential Diagnosis Coding (H57.0x)
>
> | Code | Description |
> |---|---|
> | **[[H57.01]]** | Argyll Robertson pupil, atypical — syphilitic light-near dissociation; miotic and bilateral; distinct from tonic pupil |
> | **[[H57.02]]** | Anisocoria — code when the encounter focus is the size asymmetry and a more specific cause is not yet established |
> | **[[H57.03]]** | Miosis — abnormal pupillary constriction; Horner syndrome pupil finding |
> | **[[H57.04]]** | Mydriasis — abnormal pupillary dilation; code when pharmacological or non-tonic cause is documented |
> | **[[H57.09]]** | Other anomalies of pupillary function — use when pupillary anomaly is documented but does not map to a more specific H57.0x code |
>
> #### CN III Palsy — Key Differential (Preganglionic vs. Postganglionic Lesion)
>
> | Code | Description |
> |---|---|
...
>
> #### Herpes Zoster — Viral Etiology Causing Ciliary Ganglion Damage
>
> | Code | Description |
> |---|---|
> | **[[B02.30]]** | Zoster ocular disease, unspecified |
> | **[[B02.39]]** | Other herpes zoster eye disease |
> | **[[B02.29]]** | Other postherpetic nervous system involvement — use as additional code when postherpetic autonomic neuropathy contributes to tonic pupil |
>
> #### Associated Autonomic Neuropathy Coding
>
> | Code | Description |
> |---|---|
> | **[[G90.09]]** | Other idiopathic peripheral autonomic neuropathy — for Holmes-Adie when autonomic neuropathy is explicitly documented without a specific etiology |
> | **[[G90.3]]** | Multi-system degeneration of the autonomic nervous system — when tonic pupil is part of a documented systemic autonomic neuropathy (paraneoplastic, amyloid) |
>
> ---
>
...
> |---|---|
> | **[[92004]]** | Ophthalmological services: medical examination and evaluation, comprehensive, new patient — initial evaluation of new tonic pupil/anisocoria with dilation, slit lamp, and full workup |
> | **[[92014]]** | Ophthalmological services: medical examination and evaluation, comprehensive, established patient — established patient with tonic pupil requiring dilated fundus exam and full evaluation |
> | **[[92002]]** | Ophthalmological services: medical examination and evaluation, intermediate, new patient — when visit is focused and does not meet comprehensive criteria |
> | **[[92012]]** | Ophthalmological services: medical examination and evaluation, intermediate, established patient — follow-up [[tonic pupil]] monitoring visit |
> | **[[92020]]** | Gonioscopy — slit lamp anterior segment evaluation; used in differential diagnosis workup |
> | **[[92060]]** | Sensorimotor examination with multiple measurements of ocular deviation — documents baseline motility and rules out CN III palsy when new mydriasis is evaluated |
> | **[[95930]]** | Visual evoked potential (VEP), checkerboard or flash testing, CNS except [[glaucoma]], with interpretation and report — used in neuro-ophthalmic workup when optic nerve or CNS demyelinating disease is in the differential |
> | **[[67500]]** | Retrobulbar injection; medication — targets the intraconal/orbital space at the ciliary ganglion level; rarely indicated in tonic pupil management but included for anatomical completeness |
>
> ---
>
...
> [!tip]- DERIVATIONS of [[tonic pupil]]
> ```dataview
> TABLE definition AS Definition
> FROM #medterm
> WHERE length(filter(roots, (word) => econtains([[Tonic Pupil]].roots, word))) > 0 AND file.name != [[Tonic Pupil]].file.name
> SORT file.name ASC
> ```
...
> TABLE definition AS Definition
> FROM #medterm
> WHERE length(filter(definition, (word) => econtains([[Tonic Pupil]].definition, word))) > 0 AND file.name != [[Tonic Pupil]].file.name
> ```
