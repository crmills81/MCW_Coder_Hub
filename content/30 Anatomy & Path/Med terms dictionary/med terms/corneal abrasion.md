...
> | **[[T15.00XA]]** | Foreign body in cornea, unspecified eye, initial encounter *(if foreign body present)* |
>
> ## **CPT Codes**
>
> | Code | Description |
> |---|---|
> | **[[92071]]** | Fitting of contact lens for treatment of ocular surface disease (bandage contact lens) |
> | **[[65435]]** | Removal of corneal epithelium by abrasion or curettage |
> | **920X2** | Eye examination codes (established/new patient visit series) |
> | **992XX** | E/M office visit codes (if applicable setting) |

_____
>[!tip]- DERIVATIONS of [[corneal abrasion]]
>```dataview
>TABLE definition AS Definition
>FROM #medterm 
>WHERE length(filter(roots, (word) => econtains([[corneal abrasion]].roots, word))) > 0 AND file.name != [[corneal abrasion]].file.name
>SORT file.name ASC
>```
_____
...
>TABLE definition AS Definition
>FROM #medterm 
>WHERE length(filter(definition, (word) => econtains([[corneal abrasion]].definition, word))) > 0 AND file.name != [[corneal abrasion]].file.name
>```
