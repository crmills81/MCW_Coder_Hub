...
alphabet:
  - F
definition: An electrosurgical technique that destroys tissue in situ by superficial charring and coagulation using a spark generated between an electrode held just above the tissue surface and the tissue itself, rather than by direct-contact cutting or excision.
---

>[!Note] DEFINITION of fulguration
...
>[!info]+ ETYMOLOGY of [[fulguration]]
>#latin
>
>|Component|Origin|Meaning|
>|---|---|---|
>|**[[fulgur-]]**|Latin _fulgur_ (FUL-goor)|"**lightning**," "**flash of lightning**" — root noun describing the visible electrical spark|
>|**[[fulgurat-]]**|Latin _fulgurare_ (fool-goo-RAH-ray), from _fulgur_|"**to flash like lightning**," "**to lighten**" — verb form describing the discharging action|
>|**[[-ation]]**|Latin _-atio/-ationem_|Noun-forming suffix — "**action or process of**"|
>
...
> 
> - ***[[Electrofulguration]]*** _(full clinical term specifying the electrosurgical energy source; used interchangeably with "fulguration" in most operative documentation)_
> - **[[Fulgurate]]** _(verb form — "the tumor was fulgurated"; commonly dictated in urology op notes for bladder tumor destruction)_
> - **[[Fulgurant]]** _(adjective — distinct clinical usage describing sudden, sharp, lightning-like pain, e.g., "fulgurant neuralgia"; not synonymous with the procedural sense)_
...
> ---
> 
> ### 🔧 COMMON CPT CODES (Fulguration-Related Procedures — Urology Primary Focus)
> 
> |CPT Code|Description|
> |---|---|
> |**[[52214]]**|Cystourethroscopy, with fulguration (including cryosurgery or laser surgery) of trigone, bladder neck, urethra, or periurethral glands|
...
> |**[[54065]]**|Destruction of lesion(s), penis, extensive (e.g., laser surgery, electrosurgery, cryosurgery, chemosurgery), any method|
> |**[[45190]]**|Transanal excision or fulguration of rectal tumor|
> 
> ---
> 
...
>[!tip]- DERIVATIONS of [[fulguration]]
>```dataview
>TABLE definition AS Definition
>FROM #medterm 
>WHERE length(filter(roots, (word) => econtains([[fulguration]].roots, word))) > 0 AND file.name != [[fulguration]].file.name
>SORT file.name ASC
>```
...
>TABLE definition AS Definition
>FROM #medterm 
>WHERE length(filter(definition, (word) => econtains([[fulguration]].definition, word))) > 0 AND file.name != [[fulguration]].file.name
>```
