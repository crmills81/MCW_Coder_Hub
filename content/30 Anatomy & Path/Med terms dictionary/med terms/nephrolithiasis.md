...
alphabet:
  - N
definition: The formation or presence of solid concretions,known as calculi or stones,within the kidney.
---
...
>|---|---|---|
>|**nephr- / nephro-**|Greek _nephros_ (nephrós)|"**kidney**"|
>|**lith- / litho-**|Greek _lithos_ (líthos)|"**stone**"|
>|**-iasis**|Greek _-iasis_ (í-a-sis)|Noun-forming suffix — "**morbid state or condition of**"|
>
...
> 
> - **Nephrolithic** _(adjective form — e.g., "nephrolithic disease," "nephrolithic burden")_
> - **Kidney stones** _(lay term; common in both general and clinical settings)_
> - **Renal calculi** _(clinical synonym; highly prevalent in radiology, urology, and nephrology)_
> - **Microlithiasis** _(partial/lesser form — presence of tiny, sand-like stones or gravel in the kidneys)_
> - **Staghorn calculus** _(systemic or syndromic form — large, branching stone filling the renal pelvis and calyces, typically composed of struvite and associated with chronic UTI)_
> - **Calcium oxalate stones** _(etiologic subtype 1 — the most common stone type, often driven by hypercalciuria, hyperoxaluria, or low fluid intake)_
> - **Uric acid stones** _(etiologic subtype 2 — radiolucent stones driven by persistently acidic urine and purine metabolism disorders)_
> - **Calyceal stones** _(anatomic subtype 1 — stones located specifically in the renal calyces; N20.0)_
> - **Renal pelvic stones** _(anatomic subtype 2 — stones located in the central collecting cavity of the kidney; N20.0)_
...
> ### 🏥 ICD-10-CM CODES
> 
> #### Calculus of Kidney and Ureter (N20 category)
> 
> |Code|Description|
> |---|---|
...
> 
> #### Secondary/Related Calculus Codes
> 
> |Code|Description|
> |---|---|
> |N22|Calculus of urinary tract in diseases classified elsewhere (Code first underlying disease)|
> |**[[N21.0]]**|Calculus in bladder|
> |**[[N13.2]]**|Hydronephrosis with renal and ureteral calculous obstruction|
> 
> ---
> 
> ### 🔧 COMMON CPT CODES (Nephrolithiasis-Related Diagnosis & Treatment)
> 
...
> |**[[74176]]**|Computed tomography, abdomen and pelvis; without contrast material (primary diagnostic scan)|
...
>FROM #medterm 
>WHERE length(filter(roots, (word) => econtains([[nephrolithiasis]].roots, word))) > 0 AND file.name != [[nephrolithiasis]].file.name
>SORT file.name ASC
>```
