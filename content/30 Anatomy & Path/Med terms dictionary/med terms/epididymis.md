...
forms:
  - adjective
"alphabet:": E
definition: A narrow, tightly-coiled tube attached to the posterior surface of each testis that stores and transports sperm from the testis to the vas deferens while allowing sperm to mature.
---

>[!Note] DEFINITION of [[epididymis]]
...
>[!info]+ ETYMOLOGY of [[epididymis]]
>#greek
>
>|Component|Origin|Meaning|
>|---|---|---|
>|**[[epi-]]**|Greek _ἐπί_ (epí)|"**upon**," "**over**," "**in addition to**" — a directional/locational prefix indicating position atop or adjacent to another structure|
>|**[[didym-]]**|Greek _δίδυμος_ (dídymos), from PIE root _*dwo-_ ("**two**")|"**twin**," "**double**," "**testicle**" — originally meaning "**twin**" or "**paired**," later used specifically to mean "**testicle**" since testes occur as a pair|
>|**[[-is]]**|Greek noun-forming suffix|Noun-forming suffix — "**structure or organ of**"|
>
...
> 
> - **Epididymal** _(adjective form — common clinical collocations include "epididymal cyst," "epididymal congestion," and "epididymal tenderness")_
> - **Epididymides** _(plural form used when referring to both structures, one per testis, in bilateral clinical documentation)_
> - **Caput epididymis** _(the head, or most superior/proximal portion of the structure, where efferent ductules enter)_
> - **Corpus epididymis** _(the body, or middle portion of the coiled duct)_
> - **Cauda epididymis** _(the tail, or most inferior/distal portion, which continues into the vas deferens)_
> - **Globus major** _(older anatomical term for the caput/head of the epididymis)_
> - **Globus minor** _(older anatomical term for the cauda/tail of the epididymis)_
...
> 
> #### Noninflammatory Disorders Involving the Epididymis
> 
> |Code|Description|
> |---|---|
...
> ---
> 
> ### 🔧 COMMON CPT CODES (Epididymis-Related Diagnosis & Treatment)
> 
> |CPT Code|Description|
> |---|---|
> |**[[54860]]**|Epididymectomy; unilateral — most specific/primary excisional code for isolated epididymal removal|
> |**[[54861]]**|Epididymectomy; bilateral — used when both epididymides are removed in the same session|
> |**[[54840]]**|Excision of spermatocele, with or without epididymectomy — used when a spermatocele is excised and epididymal tissue is incidentally removed|
> |**[[54830]]**|Excision of local lesion of epididymis — used for a discrete, localized epididymal mass or lesion rather than full epididymectomy|
> |**[[54865]]**|Exploration of epididymis, with or without biopsy — diagnostic exploration used to evaluate a palpable epididymal abnormality or obtain tissue for pathology|
> |**[[54900]]**|Epididymovasostomy, anastomosis of epididymis to vas deferens; unilateral — microsurgical reconstruction for obstructive azoospermia on one side|
> |**[[54901]]**|Epididymovasostomy, anastomosis of epididymis to vas deferens; bilateral — microsurgical reconstruction performed on both sides in the same session|
> |**[[54700]]**|Incision and drainage of epididymis, testis and/or scrotal space (eg, abscess or hematoma) — used for a suppurative epididymal abscess as captured by **[[N45.4]]**|
> |**[[76870]]**|Ultrasound, scrotum and contents — companion diagnostic procedure used to characterize epididymal inflammation, cystic change, or torsion of an associated appendage|
> 
> ---
> 
...
>[!tip]- DERIVATIONS of [[epididymis]]
>```dataview
>TABLE definition AS Definition
>FROM #medterm 
>WHERE length(filter(roots, (word) => econtains([[epididymis]].roots, word))) > 0 AND file.name != [[epididymis]].file.name
>SORT file.name ASC
>```
...
>TABLE definition AS Definition
>FROM #medterm 
>WHERE length(filter(definition, (word) => econtains([[epididymis]].definition, word))) > 0 AND file.name != [[epididymis]].file.name
>```
