...
forms:
  ...
  - condition
alphabet: A
definition: The complete inability to produce voice or vocal sound, resulting from severe structural, neurological, or psychological dysfunction of the larynx.
---
>[!Note] DEFINITION of [[aphonia]]
...
> | Term | Context |
> |---|---|
> | **Loss of voice / Voicelessness** | Common layperson terms documented in the History of Present Illness (HPI) |
> | **Functional aphonia** | Voice loss without identifiable structural or neurological pathology; often treated with behavioral voice therapy |
> | **Psychogenic aphonia** | **Aphonia** triggered by psychological trauma, anxiety, or stress; falls under conversion disorders |
> | **Hysterical aphonia** | Outdated historical term for psychogenic **aphonia**; no longer clinically acceptable |
> | **Whisper dysphonia** | Sometimes used interchangeably when the patient can only articulate in a breathy whisper |
...
> | Code | Description |
> |---|---|
> | **[[R49.1]]** | Aphonia _(The primary code for complete loss of voice when the cause is organic, unknown, or unspecified)_ |
> | **[[F44.4]]** | Conversion disorder with abnormal movement _(Must be used if the physician explicitly documents "psychogenic aphonia," "conversion aphonia," or "**hysterical aphonia**". Psychogenic voice disorders are excluded from R49.- codes)_ |
>
> #### **Common Underlying Definitive Conditions**
>
> | Code | Description |
> |---|---|
> | **[[J38.02]]** | Paralysis of vocal cords and larynx, bilateral _(A major structural/neurological cause of aphonia)_ |
> | **[[J04.0]]** | Acute [[laryngitis]] _(Common short-term cause)_ |
> | **[[J38.3]]** | Other diseases of vocal cords _(Includes vocal cord nodules or polyps that may prevent cord closure)_ |
>
> ---
>
> ### 🔧 COMMON CPT CODES (Aphonia Evaluation & Treatment)
>
> #### **Diagnostic Evaluation**
>
> | CPT Code | Description |
> |---|---|
> | **[[31575]]** | Laryngoscopy, flexible fiberoptic; diagnostic _(Essential primary procedure to view the vocal cords and rule out structural lesions, tumors, or paralysis)_ |
> | **[[31579]]** | Laryngoscopy, flexible or rigid telescopic, with stroboscopy _(Videostroboscopy; assesses the vibratory mucosa of the vocal folds if any phonation can be attempted)_ |
> | **[[92524]]** | Behavioral and qualitative analysis of voice and resonance _(Formal evaluation by a Speech-Language Pathologist (SLP) to assess vocal capabilities and confirm functional/psychogenic nature)_ |
>
> #### **Treatment / Speech-Language Pathology**
>
> | CPT Code | Description |
> |---|---|
> | **[[92507]]** | Treatment of speech, language, voice, communication, and/or auditory processing disorder; individual _(Primary SLP therapy code; highly effective for functional and psychogenic aphonia to 'coax' the voice back)_ |
>
> #### **Modifiers Commonly Used**
>
> | Modifier | Usage |
> |---|---|
> | **[[-25]]** | Significant, separately identifiable E&M service — append to an E&M code when a significant evaluation is performed on the same day as a diagnostic laryngoscopy (**[[31575]]**). |
> | **[[-59]]** | Distinct procedural service — used if multiple distinct evaluations/procedures are performed that normally bundle. |
>
> ---
>
