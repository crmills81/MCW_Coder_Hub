...
**Ureteral obstruction** is a blockage in one or both ureters that prevents urine from flowing from the kidneys to the bladder, potentially causing hydronephrosis and kidney damage.[^1][^2][^5]
...
| :-- | :-- | :-- |
| **Ureteropelvic Junction (UPJ)** | Where renal pelvis meets ureter (most common congenital site).[^5][^6] | Congenital narrowing, crossing vessel, high insertion, stricture. |
| **Mid-ureter** | Along course over iliac vessels | External compression (tumors, retroperitoneal fibrosis), stones. |
| **Ureterovesical Junction (UVJ)** | Where ureter enters bladder[^1] | Ureterocele, stricture, impacted stone, bladder tumors. |
...
**Intrinsic causes (within ureter):**[^5][^8][^1][^2]
...
**Extrinsic causes (external compression):**[^8][^4][^6]
...
- **Hydronephrosis:** Kidney swelling from urine backup.[^1][^6]
- **Hydroureter:** Ureteral dilation proximal to obstruction.
- **Pyonephrosis:** Infected obstructed kidney (pus in collecting system).[^1]
- **UPJ obstruction:** Ureteropelvic junction blockage (congenital or acquired).[^5][^6]
- **UVJ obstruction:** Ureterovesical junction blockage.[^1]
- **Ureterocele:** Cystic dilation of distal ureter bulging into bladder.[^4][^1]
- **Stricture:** Scarred narrowing of ureter.[^8][^5]
- **Megaureter:** Congenitally dilated ureter.[^4]
...
**Emergency management (if infected/bilateral/solitary kidney):**[^4]
...
**Definitive treatment (by cause):**[^8][^4]
...
| **Stricture** | Balloon dilation, endoureterotomy, ureteroplasty, ureteral reimplantation (50780).[^8] |
...
- **Sepsis, death:** If untreated infected obstruction.[^2][^1]
...
**Ureteral obstruction** (N13.0/N13.1, Latin/Greek *ureter-obstructio* "urinary canal blockage"), partial/complete ureteral blockage from stones (N20.1), strictures, tumors, or congenital UPJ (Q62.11) causing hydronephrosis/pain/infection, diagnosed via ultrasound/CT, treated emergently via stent (52332)/nephrostomy (50432) then definitively by pyeloplasty (50400), lithotripsy, or ureteroplasty depending on etiology.[^6][^2][^5][^4][^8][^1]

***

**Document created:** February 13, 2026
**Medical coding professional reference**
<span style="display:none">[^10][^3][^9]</span>

<div align="center">⁂</div>

[^1]: https://www.mayoclinic.org/diseases-conditions/ureteral-obstruction/symptoms-causes/syc-20354676

[^2]: https://my.clevelandclinic.org/health/diseases/21155-ureteral-obstruction

[^3]: https://www.ummhealth.org/services-treatments/urology/uteteral-obstruction

[^4]: https://www.uofmhealthsparrow.org/departments-conditions/conditions/ureteral-obstruction

[^5]: https://healthcare.utah.edu/urology/conditions/ureteral-stricture-obstruction

[^6]: https://www.ncbi.nlm.nih.gov/books/NBK560740/

[^7]: https://ugatl.com/blog/ureteral-obstruction/

[^8]: https://www.saintjohnscancer.org/urology/conditions/urinary-obstruction-urologic-reconstruction/

[^9]: https://www.clinpgx.org/disease/PA445981

[^10]: https://emedicine.medscape.com/article/438890-overview
