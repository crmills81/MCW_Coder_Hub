...
alphabet: N
definition:
  - Abnormal downward displacement of the kidney more than 5 cm or two vertebral bodies when moving from supine to upright position
  - caused by deficiency of perirenal fasciae and supporting connective tissue allowing the kidney to descend into the pelvis on orthostasis
---
>[!Note] DEFINITION of [[nephroptosis]]
...
_____
>[!info]+ ETYMOLOGY of [[nephroptosis]]
>#greek
>
>|Component|Origin|Meaning|
>|---|---|---|
>|**[[nephr-]]** / **nephro-**|Greek *nephros* (νεφρός)|"**Kidney**"|
>|**[[-ptosis]]**|Greek *ptōsis* (πτῶσις)|"**Falling, drooping, prolapse**" (from *piptein* = "to fall")|
>
...
>
> - **Floating kidney** _(most common lay and clinical synonym; reflects the untethered, mobile nature of the kidney)_
> - **Wandering kidney** _(older term; emphasizes the range of movement; used interchangeably with floating kidney)_
> - **Renal ptosis** _(descriptive clinical term; ptosis = dropping/falling)_
> - **Ren mobilis** _(classical Latin; "mobile kidney"; common in older European urological literature)_
> - **Mobile kidney** _(neutral descriptor; avoids implications of pathology; used when asymptomatic)_
> - **Kidney prolapse** _(lay patient-facing term; used in patient education materials)_
> - **Dietl's crisis** _(the acute symptomatic episode of **nephroptosis**: colicky flank pain + nausea + hematuria on standing, relieved by recumbency; named after Polish physician Józef Dietl, 1854)_
> - **[[Renal ectopia]]** _(distinct entity — fixed abnormal kidney position, NOT positional/dynamic like **nephroptosis**; important differential)_
...
> - **[[pyelonephritis]]** — kidney infection; differential diagnosis; [[N10]]
...
> ### 🏥 ICD-10-CM CODES
>
> #### **Primary Nephroptosis Code**
>
> |Code|Description|
> |---|---|
> |[[N28.83]]|Nephroptosis _(the only specific, billable ICD-10-CM code for this condition; no laterality distinction exists in this code)_|
>
> #### **Companion / Secondary Codes (Document When Present)**
>
> |Code|Description|
> |---|---|
> |[[N13.30]]|[[Hydronephrosis]], unspecified _(secondary to intermittent ureteral kinking from nephroptosis)_|
> |[[N13.39]]|Other hydronephrosis|
> |[[N13.5]]|Crossing vessel and stricture of ureter without hydronephrosis _(UPJ obstruction from positional descent)_|
> |[[R10.11]]|Right upper quadrant pain|
> |[[R10.12]]|Left upper quadrant pain|
> |[[R10.31]]|Right lower quadrant pain _(when kidney descends into RLQ — can mimic appendicitis)_|
> |[[R10.32]]|Left lower quadrant pain|
> |[[R31.9]]|Hematuria, unspecified _(symptom of symptomatic nephroptosis)_|
> |[[R31.0]]|Gross hematuria|
> |[[R31.21]]|Asymptomatic microscopic hematuria|
> |[[R80.9]]|Proteinuria, unspecified _(associated with symptomatic nephroptosis)_|
> |[[N20.0]]|Calculus of kidney _(differential/concurrent — rule out before attributing flank pain to nephroptosis)_|
> |[[N10]]|Acute [[pyelonephritis]] _(differential for flank pain)_|
> |[[N28.89]]|Other specified disorders of kidney and ureter _(use when additional renal findings not covered by specific codes)_|
>
> #### **Predisposing Condition Codes (When Documented)**
>
> |Code|Description|
> |---|---|
> |[[M35.7]]|Hypermobility syndrome _(connective tissue laxity; EDS-adjacent)_|
> |[[Q79.6]]|Ehlers-Danlos syndrome _(congenital connective tissue disorder; fascial laxity predisposing to nephroptosis)_|
> |[[E41]]|Nutritional marasmus / severe malnutrition _(extreme perirenal fat loss)_|
> |[[R63.4]]|Abnormal weight loss _(rapid weight loss — loss of perirenal fat support)_|
>
> ---
>
> ### 🔧 COMMON CPT CODES (Nephroptosis Workup & Treatment)
>
> |CPT Code|Description|
> |---|---|
> |**[[74400]]**|Urography (pyelography), intravenous, with or without KUB, with or without tomography _(IVP — upright + supine films; primary diagnostic test for nephroptosis)_|
> |**[[74178]]**|CT abdomen and pelvis, without and with contrast _(rules out other pathology; does NOT diagnose nephroptosis — static study)_|
> |**[[74177]]**|CT abdomen and pelvis with contrast _(common workup; cannot confirm positional descent)_|
> |**[[76770]]**|Ultrasound, retroperitoneal, real-time with image documentation; complete _(renal ultrasound; Doppler in upright/supine positions may document descent)_|
> |**[[78707]]**|Kidney imaging morphology; with vascular flow _(nuclear renal DMSA scan — upright vs. supine comparison for nephroptosis)_|
> |**[[78708]]**|Kidney imaging morphology; with [[vascular]] flow and function, single study _(DMSA scan with quantitative function)_|
> |**[[78709]]**|Kidney imaging morphology; with vascular flow and function, multiple studies _(serial DMSA scanning)_|
> |**[[50400]]**|Pyeloplasty (Foley Y-[[pyeloplasty]] or other type); simple _(nephropexy via open approach — used for concurrent UPJ obstruction repair)_|
> |**[[50405]]**|Pyeloplasty; complicated _(open nephropexy with complicating factors — prior surgery, horseshoe kidney, etc.)_|
> |**[[50715]]**|Ureterolysis, with or without repositioning of ureter for retroperitoneal fibrosis _(when ureteral kinking from [[nephroptosis]] requires ureterolysis)_|
> |**[[50080]]**|[[Percutaneous]] [[nephrostolithotomy]] or [[pyelostolithotomy]] _(if concurrent obstruction/stone requires decompression)_|
> |**[[50545]]**|Laparoscopic radical nephrectomy _(not for nephroptosis, but listed as differential for complex renal surgical planning)_|
> |**[[50548]]**|Laparoscopic nephrectomy, with total ureterectomy|
> |**[[99243]]**|Office or outpatient consultation, moderate complexity _(urology or nephrology consult for evaluation of symptomatic nephroptosis)_|
> |**[[99244]]**|Office or outpatient consultation, moderate-high complexity|
>
> ---
>
...
_____
>[!tip]- DERIVATIONS of [[nephroptosis]]
>```dataview
>TABLE definition AS Definition
>FROM #medterm 
>WHERE length(filter(roots, (word) => econtains([[nephroptosis]].roots, word))) > 0 AND file.name != [[nephroptosis]].file.name
>SORT file.name ASC
>```
_____
...
>TABLE definition AS Definition
>FROM #medterm 
>WHERE length(filter(definition, (word) => econtains([[nephroptosis]].definition, word))) > 0 AND file.name != [[nephroptosis]].file.name
>```
