...
forms:
  ...
  - condition
alphabet: G
definition: A chronic digestive disorder in which stomach acid or bile frequently flows back into the esophagus due to a relaxed or weakened lower esophageal sphincter, irritating the mucosal lining and causing symptoms like heartburn, regurgitation, and potential tissue damage.
icd10cm: K21.9
---
>[!Note] DEFINITION of [[GERD]]
...
_____
>[!info]+ ETYMOLOGY of [[GERD]]
>#greek #latin
>
>|Component|Origin|Meaning|
>|---|---|---|
>|**[[gastr-]]** / **[[gastro-]]**|Ancient Greek _γαστήρ_ (_gastḗr_)|"**Stomach / belly**" — indicates the anatomical origin of the refluxate; appears in [[gastritis]], [[gastroparesis]]|
>|**[[esophag-]]**|Ancient Greek _οἰσοφάγος_ (_oisophágos_)|"**Gullet / esophagus**" — indicates the anatomical destination being irritated; literally "**what carries what is eaten**"|
>|**[[re-]]**|Latin _re-_|"**Back / again**" — indicates the backward direction of the movement|
>|**[[flux]]**|Latin _fluxus_, from _fluere_|"**Flow**" — denotes the movement of fluid|
>
...
>
> - **Gastroesophageal reflux disease** *(the unabbreviated clinical standard)*
...
> |Code|Description|
> |---|---|
> |**[[K21.9]]**|Gastro-esophageal reflux disease without esophagitis *(The default code for "GERD", "acid reflux", or NERD when no mucosal damage is noted)*|
>
> ##### GERD With Esophagitis (Combination Codes)
> *(If the provider documents both GERD and esophagitis, you MUST use a combination code; do not code them separately.)*
>
> |Code|Description|
> |---|---|
> |**[[K21.00]]**|Gastro-esophageal reflux disease with esophagitis, without bleeding *(Most common code for erosive reflux disease)*|
> |**[[K21.01]]**|Gastro-esophageal reflux disease with esophagitis, with bleeding *(Provider must explicitly link the bleeding/hemorrhage to the reflux esophagitis)*|
>
> #### **Associated Conditions & Complications**
> *(Code additionally if documented)*
>
> |Code|Description|
> |---|---|
> |**[[K22.70]]**|Barrett's esophagus without dysplasia|
> |**[[K44.9]]**|Diaphragmatic hernia without obstruction or gangrene *(Hiatal hernia — very common concurrent diagnosis)*|
> |**[[R13.10]]**|Dysphagia, unspecified|
> |**[[R12]]**|Heartburn *(Do not code separately if a definitive diagnosis of GERD [K21.-] is established)*|
> |**[[J38.7]]**|Other diseases of larynx *(Often used for Laryngopharyngeal Reflux / LPR, though some coders utilize J37.0 Chronic Laryngitis depending on documentation)*|
>
> ---
>
...
> |**[[43239]]**|Esophagogastroduodenoscopy, flexible, transoral; with biopsy, single or multiple *(Billed when tissue is sent to pathology to rule out EoE or Barrett's)*|
>
> #### Motility & pH Testing
...
> |CPT Code|Description|
> |---|---|
> |**[[91010]]**|Esophageal motility (manometry) study|
...
> |**[[91035]]**|Esophagus, gastroesophageal reflux test; with mucosal attached telemetry pH electrode placement, recording, analysis and interpretation *(e.g., Bravo capsule pH test)*|
>
> #### Surgical Treatment (Anti-Reflux Procedures)
>
> |CPT Code|Description|
> |---|---|
...
> |**[[43284]]**|Laparoscopy, surgical, esophageal sphincter augmentation procedure, placement of sphincter augmentation device (e.g., magnetic band/LINX)|
>
> #### Modifiers Commonly Used
>
> |Modifier|Usage|
> |---|---|
> |**[[-26]]**|Professional component — Used for the physician's interpretation and report of motility or pH testing (**[[91010]]**, **[[91034]]**) if the facility owns the equipment.|
> |**[[-59]]**|Distinct procedural service — Used during an EGD if a biopsy (**[[43239]]**) is taken in one area and a completely distinct intervention (**like a dilation**) is performed in another.|
> |**[[-33]]**|Preventive Services — Rarely used directly for **GERD**, but if a screening colonoscopy turns into a diagnostic EGD on the same day due to **GERD** symptoms, modifiers are required to split the preventive vs. diagnostic intent.|
>
> ---
>
...
>
_____
>[!tip]- DERIVATIONS of [[GERD]]
>```dataview
>TABLE definition AS Definition
>FROM #medterm
>WHERE length(filter(roots, (word) => econtains([[GERD]].roots, word))) > 0 AND file.name != [[GERD]].file.name
>SORT file.name ASC
>```
_____
