...
alphabet:
  - H
definition: A rare,usually inherited bleeding disorder in which the blood does not clot properly due to a deficiency or absence of specific coagulation factors,most commonly Factor VIII or Factor IX.
---

>[!Note] DEFINITION of [[hemophilia]]
...
>[!info]+ ETYMOLOGY of [[hemophilia]]
>#greek
>
>|Component|Origin|Meaning|
>|---|---|---|
>|**[[hemo-]]** / **[[hem-]]**|Greek _haima_ (αἷμα)|"**blood**" — primary anatomical root referring to blood or the vascular system|
>|**[[-philia]]** / **[[phil-]]**|Greek _philia_ (φιλία), from _philos_ (loving)|"**love**," "**affection**," or clinically "**abnormal tendency toward**"|
>
...
> 
> - **Hemophilic** _(adjective form — e.g., "hemophilic arthropathy," "hemophilic pseudotumor")_
> - **Haemophilia** _(British/Commonwealth English spelling)_
> - **Bleeder's disease** _(historical lay synonym — historically used before the specific factors were identified)_
> - **Hemophilia A** _(etiologic subtype — classic hemophilia caused by a deficiency in coagulation Factor VIII; [[D66]])_
> - **Hemophilia B** _(etiologic subtype — also called Christmas disease, caused by a deficiency in Factor IX; [[D67]])_
> - **Hemophilia C** _(etiologic subtype — Rosenthal syndrome, caused by a deficiency in Factor XI, predominantly affecting Ashkenazi Jews; [[D68.1]])_
> - **Acquired hemophilia** _(etiologic subtype — rare autoimmune disorder where the immune system attacks Factor VIII; [[D68.311]])_

_____

> [!danger]+ ### 🔗 RELATED TERMS
> 
> - **Thrombophilia** — the opposite of **hemophilia**; an abnormality of **blood** **[[coagulation]]** that increases the risk of **[[thrombosis]]** (**blood clots**).
...
> |**[[D68.1]]**|Hereditary factor XI deficiency (Hemophilia C)|
> 
...
> |**[[D68.312]]**|Antiphospholipid antibody with hemorrhagic co-occurrence|
...
> |Code|Description|
> |---|---|
> |**[[M36.2]]**|Hemophilic arthropathy (Note: code underlying disease first, e.g., D66)|
> |**[[R58]]**|Hemorrhage, not elsewhere classified|
> 
> ---
> 
> ### 🔧 COMMON CPT CODES (Hemophilia-Related Diagnosis & Treatment)
> 
> |CPT Code|Description|
> |---|---|
> |**[[85240]]**|Blood coagulation factor VIII, VW factor, ristocetin cofactor|
> |**[[85250]]**|Blood coagulation factor IX|
> |**[[85270]]**|Blood coagulation factor XI|
> |**[[85730]]**|Thromboplastin time, partial (PTT); plasma or whole blood|
> |**[[96365]]**|Intravenous infusion, for therapy, prophylaxis, or diagnosis (specify substance or drug); initial, up to 1 hour (often used for factor replacement therapies)|
> 
> ---
> 
...
>[!tip]- DERIVATIONS of [[hemophilia]]
>```dataview
>TABLE definition AS Definition
>FROM #medterm 
>WHERE length(filter(roots, (word) => econtains([[hemophilia]].roots, word))) > 0 AND file.name != [[hemophilia]].file.name
>SORT file.name ASC
>```
