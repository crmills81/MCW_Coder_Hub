...
>- The word entered English in the 1650s from Late Latin "subcutaneus," itself formed from Latin "**[[sub-]]**" ("**under, beneat**h") plus "**-cutaneus**" ("**pertaining to the skin**"), which comes from "cutis" ("**the skin**"). So structurally it's **[[sub-]]** ("**under**") + **[[-cutis]]** ("**skin**") + the adjectival suffix "**[[-aneus]]**" tacked on to make it descriptive.
_____
