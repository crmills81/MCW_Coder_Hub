...
- **[[Dys-]]:** #greek prefix *[[dus-]]* = "b**ad, difficult, abnormal**."
- **[[-phagia]]:** Greek *phageîn* (φαγεῖν) = "**to eat, swallow.**"
- **Literal:** "[[Difficulty swallowin]]g" or "**abnormal eating/swallowing**."[^5]
...
- Onset, duration, solid vs. liquid, intermittent vs. progressive.
- Red flags: weight loss, smoking, hematemesis, odynophagia.

**Imaging/studies:**[^5][^1]

- **Modified barium swallow ([[74230]] CPT):** Visualize oral/pharyngeal phases, identify aspiration.
- **Barium [[esophagram]]:** Structural abnormalities, strictures, achalasia.
- **Upper endoscopy (EGD, [[43197]]):** Direct visualization, biopsy lesions.
- **Esophageal manometry ([[91010]]):** Motility disorders (achalasia, spasm).
- **pH monitoring:** Confirm GERD.
...
| Condition | Treatment |
| :-- | :-- |
| **Oropharyngeal/neurological** | Swallowing therapy (SLP), diet modification (thickened liquids, pureed foods), postural techniques. |
| **Achalasia** | Pneumatic dilation, Heller myotomy, POEM (peroral endoscopic [[myotomy]]). |
| **Strictures** | Esophageal dilation ([[43450]]), PPI for GERD-induced. |
| **GERD** | PPIs, H2 blockers, lifestyle modifications. |
| **Eosinophilic esophagitis** | Dietary elimination, topical steroids (swallowed fluticasone). |
| **Zenker diverticulum** | Surgical repair ([[diverticulectomy]], [[cricopharyngeal myotomy]]). |
| **Tumors** | Resection, stenting, radiation, chemotherapy. |
| **Aspiration risk** | NPO, PEG tube ([[percutaneous]] [[gastrostomy]]), thickened liquids. |
...
- **Aspiration pneumonia:** Food/liquid enters lungs (leading cause of death in stroke patients).[^1][^6]
- **Malnutrition/dehydration:** Inadequate oral intake.
- **Weight loss:** Failure to thrive (especially children).
- **Food impaction:** Emergency requiring endoscopic removal.
- **[[Esophageal perforation]]:** Rare but life-threatening.

***

## Red Flags (Emergency/Urgent Evaluation)

- Acute food impaction (>2-4 hours).
- Progressive dysphagia with weight loss (malignancy).
- [[Hematemesis]], [[melena]].
- History of caustic ingestion.
- New dysphagia in smoker/alcohol user (>50yo).

***

## One-Sentence Summary

**Dysphagia** ([[R13.10]], Greek *dys[[-phagia]]* "**difficulty swallowing**"), manifests as [[oropharyngeal]] (neurological/weak muscles) or esophageal (achalasia/strictures/tumors) swallowing impairment with aspiration/malnutrition risks, diagnosed via barium swallow ([[74230]])/endoscopy ([[43197]]), treated by diet modification/dilation/myotomy/SLP therapy.[^2][^3][^5][^1]
