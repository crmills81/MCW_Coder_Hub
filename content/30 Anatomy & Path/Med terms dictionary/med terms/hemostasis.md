...
> 
> - **Hemostatic** _(adjective form — e.g., "hemostatic agent," "hemostatic forceps," "hemostatic process")_
> - **Haemostasis** _(British/Commonwealth English spelling)_
> - **Arrest of bleeding** _(lay/clinical synonym — often used in surgical operative notes and trauma bays)_
> - **Primary hemostasis** _(physiological phase — the initial cellular response forming a temporary platelet plug at the injury site)_
> - **Secondary hemostasis** _(physiological phase — the enzymatic coagulation cascade that reinforces the plug with cross-linked fibrin)_
> - **Surgical hemostasis** _(clinical subtype — the intentional arrest of bleeding during an operation using physical, thermal, or chemical means)_
> - **Electrocautery / Bipolar hemostasis** _(procedural subtype — the use of heat or electrical current to seal bleeding vessels)_
