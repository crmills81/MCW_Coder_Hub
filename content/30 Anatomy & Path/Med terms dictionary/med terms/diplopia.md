...
>- **[[Binocular diplopia]]**
>	- One image from each eye, misaligned due to inability of both eyes to fuse images at a point in space.
>	- regularly caused by extraocular muscle or **cranial nerve (III, IV, VI) lesions**, [[Graves’ disease]], [[myasthenia gravis]], [[stroke]], or [[multiple sclerosis]].
>- **Monocular diplopia**
>	- Images arise from one eye only and are often optical or media‑related (e.g., [[cataracts]], uncorrected [[astigmatism]], [[keratoconus]], [[dry eye]], [[pterygium]], dislocated lens).
>	- Rare cortical causes exist but are uncommon and usually accompanied by other visual‑field deficits.​
>
>- **Pattern descriptors**  
 >   [[diplopia]] can be:
 > 	  - Horizontal
...
>#greek - **Root:** _[[di‑]]_ = Greek/Latin _[[dis‑]]_ = “**double, two**.”
>- **Root:** _[[‑ops‑]] / [[‑oplia]]_ = from Greek _ōps, ōp‑_ = “**eye**.”
>- **Root:** _[[‑plegia]]_ = Greek _plēgē_ / _plegia_ = “**stroke, paralysis**.”
>
...
> - **Cranial nerve palsies (III, IV, VI):** Frequently encode the cause of diplopia in coding scenarios.
> - **[[Monocular]] pseudovi­sion:** When functional or optical rather than neurological, sometimes labeled as monocular diplopia if no anatomic lesion is found.
> 
> ---
> 
