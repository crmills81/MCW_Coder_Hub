...
forms:
  - noun
alphabet: D
definition: diabetes-related microvascular disease of the retina ranging from nonproliferative retinal damage to proliferative neovascular disease, with or without macular edema
---
...
> [!tip]+ PATHOPHYSIOLOGY of [[diabetic retinopathy]]
> 
> - Chronic [[hyperglycemia]] injures **retinal capillaries** and the **blood-retinal barrier**.
> - Early changes include [[microaneurysms]], capillary leakage, **retinal hemorrhages**, hard [[exudates]], and ischemic injury.
> - Progressive [[ischemia]] can stimulate abnormal neovascularization, defining [[proliferative diabetic retinopathy]].
> - Retinal thickening from [[vascular]] leakage causes **diabetic macular edema (DME)**, which may develop at any stage.
_____

> [!example]+ CLINICAL STAGING of [[diabetic retinopathy]]
> 
> Stage | Description | Classic findings
> -----|-------------|----------------
> **No apparent DR** | No visible diabetic retinal lesions | Normal retinal exam
> **Mild NPDR** | Earliest clinically visible stage | Microaneurysms only
> **Moderate NPDR** | More than mild NPDR, but not severe | Increasing hemorrhages, exudates, vascular abnormalities
> **Severe NPDR** | Advanced nonproliferative disease | Extensive hemorrhages, venous beading, intraretinal microvascular abnormalities (IRMA)
> **PDR** | Proliferative disease | Retinal neovascularization, preretinal/vitreous hemorrhage
> **DME** | May occur at any stage | Retinal thickening and leakage at/near the macula
>
_____

> [!danger]+ RELATED TERMS to [[diabetic retinopathy]]
> 
> Term | Code/Type | Description
> -----|----------|-----------
> **Microaneurysms** | clinical finding | Earliest visible lesion of mild NPDR
> **Hard exudates** | clinical finding | Lipid deposits from chronic vascular leakage
> **Cotton wool spots** | clinical finding | Nerve fiber layer ischemic lesions
> **IRMA** | clinical finding | Intraretinal microvascular abnormalities seen in advanced NPDR
> **DME** | diabetic retinal complication | Diabetic macular edema; can occur at any DR stage
> **NPDR** | staging term | Nonproliferative diabetic retinopathy
> **PDR** | staging term | Proliferative diabetic retinopathy with neovascularization
> **[[Vitreous]] hemorrhage** | complication | Bleeding into vitreous from fragile neovascular vessels
> **Traction retinal detachment** | complication | Late fibrovascular complication of advanced PDR
>
_____

> [!important]+ MANAGEMENT of [[diabetic retinopathy]]
> 
...
> [!abstract]+ CODING PEARLS of [[diabetic retinopathy]]
> 
...
> - Dilated retinal examination / [[ophthalmoscopy]]
> - Color fundus photography
> - OCT (**optical coherence tomography**), especially for macular edema
> - Fluorescein angiography for [[vascular]] leakage, [[ischemia]], and [[neovascularization]] assessment
> 
...
>[!tip]- DERIVATIONS of [[diabetic retinopathy]]
>```dataview
>TABLE definition AS "Definition"
>FROM #medterm
>WHERE contains(file.name, "retinopathy")
>  OR contains(aliases, "DR")
>   OR contains(definition, "retina")
>SORT file.name ASC
>```
_____
