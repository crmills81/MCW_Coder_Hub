...
forms:
  ...
  - adjective
alphabet: M
definition: Any pathological condition, disease, or disorder of the spinal cord typically resulting in neurological deficits such as weakness, sensory loss, and autonomic dysfunction.
---

>[!Note] DEFINITION of [[myelopathy]]
...
>[!info]+ ETYMOLOGY of [[myelopathy]]
>#greek
>
>|Component|Origin|Meaning|
>|---|---|---|
>|**[[myelo-]]**|Greek _myelos_ (my-eh-los), from _muelos_ (**marrow**)|"**spinal cord**," "**bone marrow**" — combining form indicating relation to the spinal cord or bone marrow|
...
> 
> - **[[Myelopathic]]** _(adjective form — e.g., "myelopathic features," "myelopathic gait")_
...
> - **Cervical myelopathy** _(anatomic subtype; involvement of the neck region, often causing hand clumsiness and gait imbalance; [[M50.02]])_
> - **Thoracic myelopathy** _(anatomic subtype; involvement of the mid-back region, sparing the upper extremities; [[M51.04]])_
...
> 
> #### **Inflammatory and Other Intrinsic Myelopathies**
> 
> |Code|Description|
> |---|---|
> |[[G95.9]]|Disease of spinal cord, unspecified (often used for Myelopathy NOS)|
...
> |**[[63046]]**|Laminectomy, facetectomy and foraminotomy, single vertebral segment; thoracic|
> |**[[22551]]**|Arthrodesis, anterior interbody, including disc space preparation, discectomy, osteophytectomy and decompression of spinal cord and/or nerve roots; cervical below C2|
> |**[[95907]]**|Nerve conduction studies; 1-2 studies (used adjunctively to rule out peripheral neuropathy vs central myelopathy)|
...
>[!tip]- DERIVATIONS of [[myelopathy]]
>```dataview
>TABLE definition AS Definition
>FROM #medterm 
>WHERE length(filter(roots, (word) => econtains([[Myelopathy]].roots, word))) > 0 AND file.name != [[Myelopathy]].file.name
>SORT file.name ASC
>```
...
>TABLE definition AS Definition
>FROM #medterm 
>WHERE length(filter(definition, (word) => econtains([[Myelopathy]].definition, word))) > 0 AND file.name != [[Myelopathy]].file.name
>```
