...
alphabet:
  - G
definition: A ganglion is either (1) a discrete cluster of neuron cell bodies located in the peripheral nervous system that serves as a synaptic relay station between the central and peripheral nervous systems, or (2) a benign, fluid-filled cystic swelling arising from a joint capsule or tendon sheath, most commonly at the wrist — the two meanings share only an etymological root and are clinically and anatomically unrelated.
---

> [!Note] DEFINITION of [[ganglion]]
...
> [!info]+ ETYMOLOGY of [[ganglion]]
> #greek #latin
>
> | Component | Origin | Meaning |
> |---|---|---|
> | **[[gangli-]]** | Greek *γάγγλιον* (GAN-glee-on) — used by Hippocrates for tendon swellings and extended by Galen to rounded prevertebral nerve nodules; ultimately of uncertain origin, possibly Pre-Greek | "**anything gathered into a ball**," "**a rounded knot or swelling**," "**encysted tumor on a tendon or aponeurosis**" — the word carried a pathological meaning (lump, swelling) for centuries before its anatomical application to nerve clusters |
> | **[[-on]]** | Greek neuter noun suffix (-ον) | Noun-forming suffix indicating a discrete, individual object or structure; the neuter form reflects Greek grammatical convention for anatomical diminutives and structures |
>
...
> - **Autonomic nervous system** — the division of the PNS controlling involuntary visceral functions; contains both sympathetic **ganglia** (**paravertebral chain + prevertebral**) and **parasympathetic ganglia** (**terminal/intramural, near or within target organ**s)
> - **Bursal cyst** *(**M71.2–M71.3**)* — a fluid-filled cyst arising from a bursa, not a joint capsule or tendon sheath; explicitly separated from **ganglion** **cyst** in **ICD-10-CM** by **Excludes2** note at M67.4 — do not conflate without documentation specificity
...
> | Code | Description |
> |---|---|
> | **[[A66.6]]** | Bone and joint lesions of yaws — use this code (NOT M67.4x) when ganglionlike lesion is caused by *Treponema pallidum pertenue* (**yaws**); M67.4 has an **Excludes1** note for **A66.6** |
>
> #### Neural Ganglion — Tonic Pupil / Ciliary Ganglion Damage
>
> | Code | Description |
> |---|---|
...
>
> #### Neural Ganglion — CN III Palsy (Preganglionic Fiber Interruption)
>
> | Code | Description |
> |---|---|
...
>
> #### Neural Ganglion — Herpes Zoster Affecting Ganglia (Viral Ganglionitis)
>
> | Code | Description |
> |---|---|
...
> ---
>
> ### 🔧 COMMON CPT CODES (Ganglion-Related Diagnosis & Treatment)
>
> | CPT Code | Description |
> |---|---|
> | **[[25111]]** | Excision of ganglion, wrist (dorsal or volar); primary — most common surgical code for wrist ganglion; 90-day global |
> | **[[25112]]** | Excision of ganglion, wrist (dorsal or volar); recurrent — use only when prior excision of same-site ganglion is documented |
> | **[[26160]]** | Excision of lesion of tendon sheath or joint capsule (e.g., cyst, mucous cyst, or ganglion), hand or finger — use for hand/finger ganglion; not wrist |
> | **[[27630]]** | Excision of lesion of tendon sheath or capsule (e.g., cyst, ganglion), leg or ankle — ankle-level ganglion excision |
> | **[[28090]]** | Excision of lesion, tendon, tendon sheath, or capsule including synovectomy (e.g., cyst or ganglion), foot — foot-level ganglion excision |
> | **[[20612]]** | Aspiration and/or injection of ganglion cyst(s) — office-based aspiration; includes any site; no imaging guidance bundled |
> | **[[76942]]** | Ultrasonic guidance for needle placement, imaging supervision and interpretation — separately reportable when ultrasound is used for ganglion aspiration/injection with documented image guidance |
> | **[[64505]]** | Injection, anesthetic agent; sphenopalatine ganglion — neural ganglion block, pterygopalatine fossa approach |
> | **[[64510]]** | Injection, anesthetic agent; stellate ganglion (cervical sympathetic) — sympathetic ganglion block, cervicothoracic |
> | **[[64530]]** | Injection, anesthetic agent; celiac plexus, with or without radiologic monitoring — prevertebral autonomic plexus block |
...
> [!tip]- DERIVATIONS of [[ganglion]]
> ```dataview
> TABLE definition AS Definition
> FROM #medterm
> WHERE length(filter(roots, (word) => econtains([[Ganglion]].roots, word))) > 0 AND file.name != [[Ganglion]].file.name
> SORT file.name ASC
> ```
...
> TABLE definition AS Definition
> FROM #medterm
> WHERE length(filter(definition, (word) => econtains([[Ganglion]].definition, word))) > 0 AND file.name != [[Ganglion]].file.name
> ```
