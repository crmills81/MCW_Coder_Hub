...
forms:
  ...
  - inflammation
alphabet: E
definition: A rapidly progressive, potentially life-threatening bacterial infection and inflammation of the epiglottis and adjacent supraglottic structures, frequently leading to sudden airway obstruction.
---
...
>|---|---|---|
>|**[[epi-]]**|Ancient Greek _ἐπί_ (_epí_)|"**Upon, over, above**" — denotes location above or on top of something; appears in [[epidermis]], [[epicardium]], [[epigastric]]|
>|**[[glott-]]** / **[[glottis]]**|Ancient Greek _γλωττίς_ (_glōttís_), from _γλῶττα_ (_glōtta_)|"**Mouthpiece of a flute / tongue**" — anatomically refers to the vocal apparatus of the larynx (the true vocal cords and the rima glottidis); appears in [[polyglot]], [[glossectomy]]|
>|**[[-itis]]**|Ancient Greek _-ῖτις_ (_-îtis_)|Noun suffix — "**inflammation of, disease of**" — the most ubiquitous suffix for inflammatory diseases; appears in [[appendicitis]], [[dermatitis]]|
>
> **Literally**: _"Inflammation of the structure above the glottis."_ The epiglottis itself was named by early anatomists for its position directly above the **glottis**. The addition of the *-itis* suffix creates the standard medical diagnosis for its acute inflammation. While technically *epiglottiditis* is the morphologically correct formation from the Greek stem, *epiglottitis* is the universally accepted clinical and ICD standard.
_____
...
> | Term | Context |
> |---|---|
> | **Acute epiglottitis** | The standard clinical term most often seen in definitive diagnoses |
> | **Supraglottitis** | A more anatomically inclusive term often preferred by ENTs, as the inflammation usually involves the aryepiglottic folds and false cords, not just the epiglottis |
> | **Hib epiglottitis** | Specifically denotes an infection caused by *Haemophilus influenzae* type b |
> | **Epiglottiditis** | The etymologically purist spelling, though extremely rare in modern medical charts |
...
> | Code | Description |
> |---|---|
> | **[[J05.10]]** | Acute epiglottitis without airway obstruction _(Default code if obstruction is not explicitly documented)_ |
> | **[[J05.11]]** | Acute epiglottitis with airway obstruction _(Use if the provider documents impending airway compromise, stridor requiring intervention, or explicit obstruction)_ |
> | **[[J31.2]]** | Chronic laryngitis and laryngotracheitis _(Includes chronic epiglottitis, though extremely rare compared to the acute form)_ |
>
...
> ---
>
> ### 🔧 COMMON CPT CODES (Epiglottitis Evaluation & Airway Management)
>
...
> | CPT Code | Description |
> |---|---|
> | **[[31500]]** | Intubation, endotracheal, emergency procedure _(A critical procedure for epiglottitis patients with airway compromise; often done awake or via fiberoptic guidance in the OR)_ |
> | **[[31603]]** | [[Tracheostomy]], emergency procedure; transtracheal _(Performed if endotracheal intubation fails or is anatomically impossible due to the severe supraglottic swelling)_ |
> | **[[31605]]** | [[Tracheostomy]], emergency procedure; cricothyroid membrane ([[cricothyroidotomy]]) _(The absolute last-resort surgical airway)_ |
>
> #### **Modifiers Commonly Used**
>
> | Modifier | Usage |
> |---|---|
> | **[[-25]]** | Significant, separately identifiable E&M service — Append to the Critical Care (e.g., **[[99291]]**) or ED visit code if an emergent procedure (like intubation **[[31500]]**) is performed during the same encounter. |
> | **[[-59]]** | Distinct procedural service — Used if a diagnostic laryngoscopy (**[[31575]]**) is performed distinctly and separately from a subsequent surgical airway intervention. |
>
> ---
>
