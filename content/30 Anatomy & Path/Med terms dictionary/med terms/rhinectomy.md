...
> 
> - **Rhinectomized** _(adjectival form — used to describe the post-operative state or defect, e.g., "rhinectomized wound bed," "rhinectomized patient")_
> - **Nasal [[resection]] / Nose removal** _(lay and clinical terms; often used in patient education and oncology consent forms)_
> - **Partial rhinectomy** _(removal of a portion of the nose, such as the lower half, ala, or tip; preserves the nasal bridge and upper cartilages)_
> - **Total rhinectomy** _(complete removal of the external nose down to the level of the nasal bones and maxilla)_
> - **Subtotal rhinectomy** _(removal of the majority of the external nose, sparing only a small rim of tissue or the nasal root)_
> - **[[C30.0]]** _(Malignant neoplasm of nasal cavity; the most common primary oncologic indication requiring this procedure)_
> - **[[Z90.09]]** _(Acquired absence of other parts of head and neck; used to code the post-procedural status of a patient missing their nose)_
> - **[[B46.1]]** _(Rhinocerebral mucormycosis; an invasive fungal infection that may necessitate radical nasal debridement/rhinectomy)_
> - **Nasal cavity ablation** _(clinical descriptor synonym used in broader head and neck tumor board discussions)_
> - **Midfacial resection** _(broader anatomic subtype that may include rhinectomy along with maxillectomy or orbital exenteration for advanced tumors)_
...
> |**[[C44.392]]**|Other specified malignant neoplasm of skin of right part of nose|
> |**[[C44.399]]**|Other specified malignant neoplasm of skin of unspecified part of face|
> 
> #### Acquired Absence & Post-Procedural Status (Follow-up & Aftercare)
> 
> |Code|Description|
> |---|---|
> |**[[Z90.09]]**|Acquired absence of other parts of head and neck (includes acquired absence of nose)|
> |**[[Z48.810]]**|Encounter for surgical aftercare following surgery on the sense organs|
> |**[[Z48.89]]**|Encounter for other specified surgical aftercare (e.g., post-op flap checks)|
> 
> #### Benign/In-Situ Neoplasms & Destructive Infectious Lesions
> 
> |Code|Description|
> |---|---|
> |**[[D02.3]]**|Carcinoma in situ of other parts of respiratory system (includes nasal cavity)|
> |**[[D14.0]]**|Benign neoplasm of middle ear, nasal cavity and accessory sinuses|
> |**[[B46.1]]**|Rhinocerebral mucormycosis (destructive fungal infection requiring radical debridement)|
> 
> ---
> 
> ### 🔧 COMMON CPT CODES (Rhinectomy & Associated Reconstruction)
> 
> |CPT Code|Description|
> |---|---|
> |**[[30150]]**|Rhinectomy, partial (removal of lower half, ala, or tip)|
> |**[[30160]]**|Rhinectomy, total (complete removal of external nose)|
> |**[[30400]]**|Rhinoplasty, primary; lateral and alar cartilages and/or elevation of nasal tip (used in reconstructive phase)|
> |**[[30410]]**|Rhinoplasty, primary; including major septal repair|
> |**[[30420]]**|Rhinoplasty, primary; including major septal repair AND osteotomies|
> |**[[15732]]**|Muscle, myocutaneous, or fasciocutaneous flap; head and neck (pedicled flap reconstruction)|
> |**[[15758]]**|Free fasciocutaneous flap with microvascular anastomosis; head and neck (free flap reconstruction)|
> |**[[15220]]**|Skin graft; full thickness, free; face, ears, eyelids, nose, lips, mucous membranes (first 20 sq cm or less)|
> |**[[14060]]**|Adjacent tissue transfer or rearrangement, forehead, cheeks, chin, neck; defect 10 sq cm or less|
> |**[[14061]]**|Adjacent tissue transfer or rearrangement, forehead, cheeks, chin, neck; defect 10.1 to 30.0 sq cm|
> |**[[69990]]**|Microsurgical techniques, requiring use of operating microscope (add-on code for microvascular anastomosis)|
> 
> ---
> 
...
>[!tip]- DERIVATIONS of [[rhinectomy]]
>```dataview
>TABLE definition AS Definition
>FROM #medterm 
>WHERE length(filter(roots, (word) => econtains([[rhinectomy]].roots, word))) > 0 AND file.name != [[rhinectomy]].file.name
>SORT file.name ASC
>```
...
>TABLE definition AS Definition
>FROM #medterm 
>WHERE length(filter(definition, (word) => econtains([[rhinectomy]].definition, word))) > 0 AND file.name != [[rhinectomy]].file.name
>```
