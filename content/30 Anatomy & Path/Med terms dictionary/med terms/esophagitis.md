...
forms:
  ...
  - inflammation
alphabet: E
definition: Acute or chronic inflammation of the mucosal lining of the esophagus, most commonly caused by gastroesophageal acid reflux, allergic responses, infections, or medication irritation.
icd10cm: K20.90
---
>[!Note] DEFINITION of [[esophagitis]]
...
_____
>[!info]+ ETYMOLOGY of [[esophagitis]]
>#greek #latin
>
>|Component|Origin|Meaning|
>|---|---|---|
>|**[[esophag-]]** / **[[esophago-]]**|Ancient Greek _οἰσοφάγος_ (_oisophágos_)|"**Gullet, esophagus**" — literally translated from _oisein_ ("**to carry**") + _phagein_ ("**to eat**"); underlying [[esophagectomy]], [[esophagoscopy]]|
>|**[[-itis]]**|Ancient Greek _-ῖτις_ (_-îtis_)|Noun suffix — "**inflammation of, disease of**" — the most ubiquitous suffix for inflammatory diseases; appears in [[gastritis]], [[appendicitis]], [[dermatitis]]|
>
> **Literally**: _"Inflammation of the structure that carries food."_ The term utilizes the standard anatomical root for the esophagus combined with the universal inflammatory suffix. In older or British medical literature, it is often spelled **[[oesophagitis]]**. The specific subsets of the disease add modifying prefixes or terms, such as _eosinophilic_ **(from eosin, a red dye used in histology, + _-phil_, loving/attracted to, due to the cells' appearance under a microscope**).
_____
...
> | Term | Context |
> |---|---|
> | **Reflux esophagitis** | The most common variant; heavily tied to GERD and acid erosion of the distal esophagus |
> | **Eosinophilic esophagitis (EoE)** | Chronic allergic/immune condition; typically seen in younger patients; requires >15 eosinophils/HPF on biopsy for diagnosis |
> | **Candida esophagitis** | Fungal infection of the esophagus; presents with white plaques; common in HIV/AIDS or patients on inhaled corticosteroids |
> | **Pill esophagitis** | Chemical/erosive damage from medications lodging in the esophagus; often presents as a localized "kissing" ulcer |
> | **Oesophagitis** | British/international English spelling |
...
> | Code | Description |
> |---|---|
> | **[[K21.00]]** | Gastro-esophageal reflux disease with **esophagitis**, without bleeding _(The most common combination code for reflux esophagitis)_ |
> | **[[K21.01]]** | Gastro-esophageal reflux disease with **esophagitis**, with bleeding |
> | **[[K20.90]]** | **Esophagitis**, unspecified without bleeding _(Use when GERD is not documented and no other specific etiology is provided)_ |
> | **[[K20.91]]** | **Esophagitis**, unspecified with bleeding |
> | **[[K20.0]]** | Eosinophilic **esophagitis** _(Specific code for EoE; requires pathological confirmation in the chart)_ |
> | **[[K20.80]]** | Other **esophagitis** without bleeding _(Often used to map pill-induced or chemical esophagitis; usually requires an external cause code for the drug/toxin)_ |
>
...
> | Code | Description |
> |---|---|
> | **[[B37.81]]** | Candidal esophagitis _(Also known as esophageal thrush)_ |
> | **[[B00.81]]** | Herpesviral esophagitis _(HSV esophagitis)_ |
> | **[[B25.8]]** | Other cytomegaloviral diseases _(CMV esophagitis)_ |
>
> ---
>
> ### 🔧 COMMON CPT CODES (Esophagitis Evaluation & Treatment)
>
...
>
> #### **Pathology (Billed by Pathologist or Facility)**
>
> | CPT Code | Description |
> |---|---|
> | **[[88305]]** | Level IV - Surgical pathology, gross and microscopic examination _(Used for examining the esophageal biopsy to confirm eosinophils or fungal elements)_ |
>
> #### **Modifiers Commonly Used**
>
> | Modifier | Usage |
> |---|---|
> | **[[-33]]** | Preventive Services — *Rarely* applies to **esophagitis** directly, but if a screening colonoscopy turns into a diagnostic EGD same-day, modifiers dictate the split. |
> | **[[-59]]** | Distinct procedural service — Used if a biopsy (**[[43239]]**) is taken in the esophagus, and a completely separate technique/intervention is performed in the stomach or duodenum during the same EGD. |
> | **[[-26]]** | Professional component — Used by the physician reading the pathology slide (**[[88305]]**) if they do not own the lab equipment. |
>
> ---
>
...
_____
>[!tip]- DERIVATIONS of [[esophagitis]]
>```dataview
