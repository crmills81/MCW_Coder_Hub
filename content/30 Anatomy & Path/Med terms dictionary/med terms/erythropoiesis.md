...
>**(from Greek ἐρυθρός, _erythros_, meaning _red_, and ποίησις, _poiēsis_, meaning _creation_, _production_, _making_)** is the process which produces [red blood cells](https://en.wikipedia.org/wiki/Red_blood_cell "Red blood cell") (erythrocytes), which is the development from erythropoietic stem cell to mature red blood cell.
>
