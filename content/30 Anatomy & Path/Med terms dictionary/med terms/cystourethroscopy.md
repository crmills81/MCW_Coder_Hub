...
>FROM #medterm 
>WHERE length(filter(roots, (word) => econtains([[cystourethroscopy]].roots, word))) > 0 AND file.name != [[cystourethroscopy]].file.name
>SORT file.name ASC
>```
_____
...
>TABLE definition AS Definition
>FROM #medterm 
>WHERE length(filter(definition, (word) => econtains([[cystourethroscopy]].definition, word))) > 0 AND file.name != [[cystourethroscopy]].file.name
>```
...
> - **0TJD8ZZ** - Inspection of urethra, endoscopic.
> 
> **Diagnoses justifying:** **[[N39.0]]** (UTI), **[[R32]]** (incontinence), N20.x (stones), **[[D49.4]]** (bladder **[[neoplasm]]**).[
> 
> ## Common Indications
> 
> - **Diagnostic:** **[[Hematuria]]**, recurrent **[[UTI]], [[incontinence]]**, irritative voiding, stones, suspected tumors**/[[diverticula]]**.
> - **Therapeutic:** TURBT (**[[transurethral]] [[resection]] bladder tumor**), biopsy, stone removal, stricture dilation, foreign body extraction, stent placement.
> - **Male-specific:** Evaluate BPH/prostate, **[[urethral stricture]**].
> 
> ## Procedure Details
> 
...
> 5. **Post:** **[[dysuria]]/[[hematuria]]** 1-2 days; rare fever/infection.
> 
> ## Related Terms
> 
