...
alphabet: L
definition:
  - Inability to completely close one or both eyelids, resulting in chronic ocular surface exposure, dryness, and risk of corneal damage ranging from superficial keratopathy to corneal ulceration and vision loss
---
>[!Note] DEFINITION of [[lagophthalmos]]
...
_____
>[!info]+ ETYMOLOGY of [[lagophthalmos]]
...
> [!tip]+ ## **Common Clinical Causes by Type**
>
...
> | **[[H02.211]]** | Cicatricial lagophthalmos, right upper eyelid *(scarring, post-blepharoplasty, burn)* |
...
> | **[[H02.221]]** | Mechanical lagophthalmos, right upper eyelid *(proptosis, exophthalmos, floppy eyelid)* |
...
> | **[[H02.231]]** | Paralytic lagophthalmos, right upper eyelid *(Bell's palsy, CN VII palsy — G51.0 sequences first)* |
...
> | **[[H16.231]]** | Neurotrophic keratitis / exposure keratopathy, right eye *(code additionally when present)* |
> | **[[H16.232]]** | Neurotrophic keratitis / exposure keratopathy, left eye |
> | **[[G51.0]]** | Bell's palsy *(underlying cause for paralytic lagophthalmos — sequence first)* |
>
> ## **CPT Codes — Surgical Treatment**
>
> | Code | Description |
> |---|---|
> | **[[67880]]** | Construction of conjunctival flap (tarsorrhaphy), **temporary** — partial lid margin adhesion to reduce palpebral fissure |
> | **[[67882]]** | Construction of conjunctival flap (tarsorrhaphy) with **transposition of tarsal plate** — permanent tarsorrhaphy |
> | **[[67912]]** | Correction of lagophthalmos, with implantation of upper eyelid lid load (e.g., **gold weight, platinum weight**) |
> | **[[67950]]** | Canthoplasty — lateral or medial canthal reconstruction; lower lid tightening as adjunct to gold weight |
> | **[[67917]]** | Repair of ectropion, extensive — when paralytic ectropion coexists; G51.0 sequences first |
> | **[[67914]]** | Repair of ectropion, suture — when mild paralytic ectropion coexists |
>
> ## **Common Modifiers**
>
> | Modifier | Use |
...
>FROM #medterm 
>WHERE length(filter(roots, (word) => econtains([[lagophthalmos]].roots, word))) > 0 AND file.name != [[lagophthalmos]].file.name
>SORT file.name ASC
>```
_____
...
>TABLE definition AS Definition
>FROM #medterm 
>WHERE length(filter(definition, (word) => econtains([[lagophthalmos]].definition, word))) > 0 AND file.name != [[lagophthalmos]].file.name
>```
