...
alphabet:
  - G
definition: A specialized fibrous,peg-and-socket synarthrotic joint that anchors the root of each tooth into its bony alveolar socket in the maxilla or mandible via the periodontal ligament
---

>[!Note] DEFINITION of [[gomphosis]]
...
>[!info]+ ETYMOLOGY of [[gomphosis]]
>#greek
>
>|Component|Origin|Meaning|
>|---|---|---|
>|**[[gompho-]]**|Greek _gomphos_ (GOM-fos)|"**bolt**," "**nail**," "**peg**" — referring to a wooden bolt or nail driven into a surface; descriptive of the tooth root driven into the alveolar socket|
>|**[[-sis]]**|Greek _-sis_ (SIS)|Noun-forming suffix — "**process of**," "**state of**," "**action of**" — forming abstract nouns denoting a condition or process|
>
...
> 
> - **Peg-and-socket joint** _(lay anatomical descriptor; the most widely used informal name in anatomy education; the tooth root = peg, alveolar socket = socket)_
> - **Dentoalveolar syndesmosis** _(formal anatomical synonym used in modern joint classification; reflects the ligamentous fibrous nature of the union; used interchangeably in histology and dental anatomy texts)_
> - **Tooth socket joint** _(plain-language lay term; used in patient education and general anatomy contexts)_
> - **[[Synarthrosis]]** _(functional classification; describes the minimal-movement nature of the gomphosis; gomphosis is a subtype of synarthrosis)_
> - **Fibrous joint** _(structural classification; the broadest joint category to which gomphosis belongs in modern anatomical classification)_
> - **Periodontal joint** _(colloquial clinical descriptor; highlights the role of the periodontal ligament as the defining functional element of the gomphosis)_
> - **Alveolodental joint** _(alternate descriptive name referencing both articulating structures — the alveolar bone and the dental root)_
...
> |**[[K05.4]]**|Periodontosis (non-inflammatory degeneration of the periodontium/gomphosis)|
> |**[[K05.5]]**|Other periodontal diseases|
> |**[[K05.6]]**|Periodontal disease, unspecified|
> 
> #### Tooth Displacement / Gomphosis Disruption — Traumatic (S03)
> 
> |Code|Description|
> |---|---|
> |**[[S03.2XXA]]**|Dislocation of tooth, initial encounter (luxation/avulsion — traumatic disruption of gomphosis)|
> |**[[S03.2XXD]]**|Dislocation of tooth, subsequent encounter|
> |**[[S03.2XXS]]**|Dislocation of tooth, sequela|
> 
> #### Dental Ankylosis — Obliteration of Gomphosis
> 
> |Code|Description|
> |---|---|
> |**[[K08.51]]**|Partial loss of teeth due to periodontal diseases, class I|
> |**[[K08.52]]**|Partial loss of teeth due to periodontal diseases, class II|
> |**[[K08.53]]**|Partial loss of teeth due to periodontal diseases, class III|
> |**[[K08.54]]**|Partial loss of teeth due to periodontal diseases, class IV|
> 
> #### Nutrient Deficiency Affecting Gomphosis
> 
> |Code|Description|
> |---|---|
> |**[[E54]]**|Ascorbic acid deficiency (scurvy — collagen breakdown destroys periodontal ligament/gomphosis)|
> 
> ---
> 
...
> |---|---|
> |**[[41899]]**|Unlisted procedure, dentoalveolar structures (used when a procedure involving the gomphosis/periodontal ligament does not map to a specific CPT code)|
> |**[[70300]]**|Radiologic examination, teeth; single view (periapical X-ray — primary imaging to evaluate the periodontal ligament space and alveolar bone of the gomphosis)|
...
> |**[[21085]]**|Impression and custom preparation, oral surgical splint (used post-trauma to stabilize a luxated/avulsed tooth and protect the disrupted gomphosis during healing)|
> |**[[41820]]**|Gingivectomy, excision of gingiva, each quadrant (treats hypertrophic gingival tissue overlying the gomphosis in advanced periodontal disease)|
> |**[[41830]]**|Alveolectomy, including curettage of osteitis or sequestrectomy, one quadrant (removal of diseased alveolar bone that forms the socket wall of the gomphosis)|
> |**[[21215]]**|Graft, bone; mandible (autogenous and/or allograft) (socket/alveolar reconstruction restoring the osseous component of destroyed gomphosis sites)|
> |**[[20670]]**|Removal of implant; superficial (removal of implant hardware at or near alveolar bone — adjacent to gomphosis site)|
> |**[[20680]]**|Removal of implant; deep (removal of deep implant hardware within alveolar/jaw bone)|
> 
> ---
> 
...
>[!tip]- DERIVATIONS of [[gomphosis]]
>```dataview
>TABLE definition AS Definition
>FROM #medterm 
>WHERE length(filter(roots, (word) => econtains([[gomphosis]].roots, word))) > 0 AND file.name != [[gomphosis]].file.name
>SORT file.name ASC
>```
...
>TABLE definition AS Definition
>FROM #medterm 
>WHERE length(filter(definition, (word) => econtains([[gomphosis]].definition, word))) > 0 AND file.name != [[gomphosis]].file.name
>```
