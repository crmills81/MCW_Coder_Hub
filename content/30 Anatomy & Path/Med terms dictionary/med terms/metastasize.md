...
alphabet: M
definition:
  - process by which cancer cells spread from the primary tumor site
---
>[!Note] DEFINITION of [[metastasize]]
...
_____
> [!important]+ ETYMOLOGY of [[metastasize]]
> 
> #greek Derived from Greek roots:
> 
> - **Meta-:** Meaning "**after**," "**beyond**," or "**change**."
> - **Stasis:** From Greek _histanai_, meaning "**to place**" or "**to stand**."
...
> 
> **CPT Codes** _CPT codes depend on procedures performed to diagnose, stage, or treat metastatic disease. There is no CPT code for "metastasize" as a diagnosis._
> 
...
>
_____
>[!tip]- DERIVATIONS of [[metastasize]]
>```dataview
