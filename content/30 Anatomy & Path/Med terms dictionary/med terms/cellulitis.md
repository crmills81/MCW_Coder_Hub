...
> 
> _Cellulitis codes are primarily organized by anatomical location under Category L03. Specificity regarding laterality (Left vs. Right) is crucial for avoiding denials._
> 
> **Category L03: Cellulitis and acute [[lymphangitis]]**
> - **L03.01x:** Cellulitis of finger/toe.
>     - _Example:_ **[[L03.011]]** (**Cellulitis of right finger**) vs. **[[L03.012]]** (**Cellulitis of left finger**).
> - **L03.11x:** Cellulitis of part of limb.
>     - _Example:_ **[[L03.115]]** (**Cellulitis of right lower lim**b) vs. **[[L03.116]]** (**Cellulitis of left lower limb**).
> - **[[L03.211]]:** Cellulitis of face. (Note: **Specific codes exist for other facial parts like the eyelid, which are excluded here**).
> - **[[L03.311]]:** Cellulitis of abdominal wall.
> - **[[L03.90]]:** Cellulitis, unspecified.
> 
>  _Warning:_ Avoid using this code if the location is known. Payer policies often flag unspecified codes for audit or denial.
> 
> 
> **Related Codes:**
> 
...
>     - _Usage:_ Rarely used for simple cellulitis. Reserved for cases where there is significant devitalized tissue requiring removal (e.g., **sloughing skin**).
> 
...
> 
> - Acute [[lymphangitis]].
> - Infection of nail ([[paronychia]]) - distinct codes L03.0-.
> 
...
> 
> - _Concurrent Conditions:_
>     - Burn (T20-T31) - You can code a burn _and_ a secondary cellulitis infection if the infection developed later.
>     - Complication of surgical procedure (T81.4) - Used if the cellulitis is a direct result of a recent surgery (Surgical Site Infection).
> 
...
> - **[[Lymphadenopathy]]:** Swollen, tender lymph nodes near the infection site (**e.g., groin pain with a leg infection**).
> 
> ### Clinical Pearls for Coding
> 
> - **"Cellulitis vs. [[Abscess]]":**
>     - _Rule:_ If a patient has an abscess with minor surrounding redness, code only the **Abscess (L02)**
>     - _Exception:_ If the cellulitis is extensive and regionally distinct from the abscess, or requires specific management (e.g., systemic IV antibiotics) in addition to the drainage, **both** may be coded.
> 
