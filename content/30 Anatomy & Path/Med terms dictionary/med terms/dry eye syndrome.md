...
alphabet: D
definition:
  - A multifactorial disease of the ocular surface characterized by loss of tear film homeostasis due to insufficient tear production, accelerated tear evaporation, or tear film compositional imbalance, resulting in ocular discomfort, visual disturbance, and potential corneal damage
---
>[!Note] DEFINITION of [[dry eye syndrome]]
...
---
> [!info]+ ETYMOLOGY of [[dry eye syndrome]]
> 
> #latin #greek
> 
> |Component|Origin|Meaning|
> |---|---|---|
> |**[[kerat-]]** / **[[kerato-]]**|Greek *κέρας* (*kéras*) — "**horn, hard substance**"|Applied to the cornea for its tough, horn-like quality; root of *[[keratitis]]* (**corneal inflammation**), *keratotomy* (**corneal incision**), *keratin* (structural protein)|
> |**[[conjunctiv-]]**|Latin *conjunctīva* (sc. *tunica*) — "**connecting membrane**"; from *conjungere* — "**to join together**"|Named by Renaissance anatomists for the continuous membrane connecting the inner eyelids to the anterior globe surface; *[[con-]]* (**together**) + *jungere* (**to yoke, join**)|
> |**[[-itis]]**|Greek *-ῖτις* (*-itis*) — "**inflammation of**"|Universal medical inflammation suffix; signals active immune/inflammatory process|
> |**[[sicc-]]** / **[[sicca]]**|Latin *siccus* — "**dry, parched, arid**"|Used in *[[keratoconjunctivitis]] sicca* as a modifying adjective meaning "dry"; also root of *desiccation*, *siccative*; cognate with Greek *iskhein* ("**to hold back**")|
> 
...
>
> ### Dry Eye Syndrome — H04.12x (Aqueous Deficiency / Tear Film Insufficiency)
>
> | ICD-10-CM Code | Description |
> |---|---|
> |**[[H04.121]]**|Dry eye syndrome of right lacrimal gland *(includes "tear film insufficiency NOS" when documented)*|
> |**[[H04.122]]**|Dry eye syndrome of left lacrimal gland|
> |**[[H04.123]]**|Dry eye syndrome of bilateral lacrimal glands *(most common billable code — DES is typically bilateral)*|
> |**[[H04.129]]**|Dry eye syndrome of unspecified lacrimal gland *(avoid — query for laterality)*|
>
> ### Keratoconjunctivitis Sicca — H16.22x (Corneal Involvement; Non-Sjögren's)
>
> | ICD-10-CM Code | Description |
> |---|---|
> |**[[H16.221]]**|Keratoconjunctivitis sicca, not specified as Sjögren's, right eye *(more severe DES with corneal desiccation/staining; Excludes1: Sjögren's → use M35.01)*|
...
>
> ### Sjögren's Syndrome — Use Instead of H04.12x / H16.22x
>
> | ICD-10-CM Code | Description |
> |---|---|
> |**[[M35.01]]**|Sjögren syndrome with keratoconjunctivitis *(primary Sjögren's with dry eye — do NOT additionally code H04.12x or H16.22x; M35.01 is complete; Excludes1 in both H04.12 and H16.22)*|
> |**[[M35.00]]**|Sjögren syndrome, unspecified *(when dry eye not specifically documented with Sjögren's)*|
>
> ### DES Complications (Code Additionally When Present)
>
> | ICD-10-CM Code | Description |
> |---|---|
> |**[[H16.121]]**|Filamentary keratitis, right eye *(mucous filaments adherent to cornea — severe DES complication)*|
> |**[[H16.122]]**|Filamentary keratitis, left eye|
> |**[[H16.123]]**|Filamentary keratitis, bilateral|
> |**[[H16.231]]**|Neurotrophic keratoconjunctivitis, right eye *(corneal desensitization from severe chronic DES)*|
> |**[[H16.232]]**|Neurotrophic keratoconjunctivitis, left eye|
> |**[[H16.233]]**|Neurotrophic keratoconjunctivitis, bilateral|
> |**[[H01.001]]**|Blepharitis, right upper eyelid *(concurrent MGD/blepharitis — code with H04.12x when both documented)*|
...
> |---|---|
> |**[[92002]]**|Ophthalmological services; new patient, intermediate *(new patient DES evaluation — less complex)*|
> |**[[92004]]**|Ophthalmological services; new patient, comprehensive *(new patient complete DES workup including anterior segment, Schirmer, staining — all within exam)*|
...
> | CPT Code | Description |
> |---|---|
> |**0207T**|Evacuation of meibomian glands, automated, using heat and pressure *(LipiFlow, TearCare — Category III; verify payer coverage before billing; Medicare non-covered)*|
> |**0563T**|Evacuation of meibomian glands using heat delivered by device, per treatment session *(alternative Category III for thermal treatments including some IPL systems; payer coverage highly variable)*|
> |**[[17999]]**|Unlisted procedure, skin, mucous membrane and subcutaneous tissue *(used for IPL [intense pulsed light] dry eye treatment when no specific CPT applies; requires special report; payer specific)*|
>
> ### Advanced / Severe DES Interventions
>
> | CPT Code | Description |
> |---|---|
...
>
> | Modifier | Usage in Dry Eye Context |
> |---|---|
> |**[[-RT]]**|Right side — for unilateral punctal plug (**[[68761]]**), amniotic membrane (**[[65778]]**/**[[65779]]**), or other lateralized procedures|
> |**[[-LT]]**|Left side — same; required for all unilateral lacrimal/ocular surface procedures|
> |**[[-50]]**|Bilateral — bilateral amniotic membrane placement (**[[65778]]**) or bilateral thermal pulsation (**0207T**) at same session; note: **[[68761]]** is typically billed per punctum with -E1 through -E4 rather than -50|
> |**[[-E1]]**|Upper left eyelid punctum — **critical for punctal plug billing**; [[68761]] is billed per individual punctum and -E1 through -E4 identify which punctum was treated|
> |**[[-E2]]**|Lower left eyelid punctum|
...
---
>[!tip]- DERIVATIONS of [[dry eye syndrome]]
>```dataview
