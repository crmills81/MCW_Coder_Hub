...
aliases:
  ...
  - dementia praecox
  - Psychotic disorder
  - psychotic disorder — broader diagnostic category
  - Schizophrenia
roots:
  - schiz-
  - schizo-
...
alphabet:
  - S
definition: A chronic, severe psychotic disorder characterized by disturbances in thought process, perception, affect, and behavior, marked by hallucinations, delusions, disorganized speech, and impaired social/occupational functioning
---

>[!Note] DEFINITION of [[schizophrenia]]
...
>[!info]+ ETYMOLOGY of [[schizophrenia]]
>#greek
>
>|Component|Origin|Meaning|
>|---|---|---|
>|**[[schiz-]]** / **schizo-**|Greek _σχίζειν_ (schízein)|"**to split**," "**to divide**" — combining prefix describing a splitting or fragmenting process|
>|**[[phren-]]**|Greek _φρήν_ (phrḗn), genitive _φρενός_ (phrenós)|"**mind**," "**diaphragm**," "**seat of the emotions**" (ancient Greeks believed the diaphragm housed the mind/emotions)|
>|**[[-ia]]**|Greek/Latin _-ia_|Noun-forming suffix — "**condition or state of**"|
>
...
> 
> - **Schizophrenic** _(adjective form — "schizophrenic episode," "schizophrenic relapse," "schizophrenic spectrum")_
> - **Dementia praecox** _(historical/obsolete synonym, Kraepelin-era term; no longer used clinically, retained for chart-history context only)_
> - **Chronic psychotic disorder** _(lay/clinical descriptor; used loosely in general medical documentation)_
> - **Paranoid schizophrenia** _(legacy subtype descriptor — coded [[F20.0]])_
> - **Catatonic schizophrenia** _(legacy subtype descriptor with prominent catatonic features — coded [[F20.2]])_
> - **Residual schizophrenia** _(chronic phase with diminished positive symptoms but persistent negative symptoms — coded [[F20.5]])_
> - **First-episode psychosis (FEP)** _(clinical descriptor for the initial presentation, often before a formal schizophrenia diagnosis is confirmed)_
> - **Treatment-resistant schizophrenia (TRS)** _(etiologic/severity subtype — inadequate response to ≥2 antipsychotic trials; not separately coded, documented as clinical modifier)_
...
> ### 🏥 ICD-10-CM CODES
> 
> #### Schizophrenia (F20 — No Laterality Required)
> 
> |Code|Description|
> |---|---|
...
> 
> #### Related Psychotic Spectrum Disorders
> 
> |Code|Description|
> |---|---|
...
> ---
> 
> ### 🔧 COMMON CPT CODES (Schizophrenia-Related Diagnosis & Treatment)
> 
...
> |**[[90863]]**|Pharmacologic management, with psychotherapy services|
> |**[[90870]]**|Electroconvulsive therapy (ECT), including necessary monitoring|
> |**[[96116]]**|Neurobehavioral status exam, first hour (used for cognitive/functional assessment)|
> 
> ---
> 
...
>[!tip]- DERIVATIONS of [[schizophrenia]]
>```dataview
>TABLE definition AS Definition
>FROM #medterm 
>WHERE length(filter(roots, (word) => econtains([[schizophrenia]].roots, word))) > 0 AND file.name != [[schizophrenia]].file.name
>SORT file.name ASC
>```
...
>TABLE definition AS Definition
>FROM #medterm 
>WHERE length(filter(definition, (word) => econtains([[schizophrenia]].definition, word))) > 0 AND file.name != [[schizophrenia]].file.name
>```
