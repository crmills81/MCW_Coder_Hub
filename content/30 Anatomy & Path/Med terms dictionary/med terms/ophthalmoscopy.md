...
alphabet:
  - O
definition: Visual examination of the interior of the eye, including the retina, optic disc, macula, and retinal blood vessels, using an ophthalmoscope.
---
...
>[!info]+ ETYMOLOGY of [[ophthalmoscopy]]
>#greek
>
>|Component|Origin|Meaning|
>|---|---|---|
>|**[[ophthalm-]]**|Greek *ophthalmós* (“eye”)|mid‑19th century** as *ophthalmoscopy* (**noun**)|
>|**[[-scopy]]**|Greek _ὀφθαλμός (ophthalmós)_ (pronounced “of-thal-MOS”)|“**eye**”|
>|**[[-ic]]**|Greek _-σκοπία (-skopía)_ from _σκοπέω (skopéō)_ “to look at, examine”|Noun-forming suffix — “**examination of**”|
>
...
> - **[[Ophthalmoscope]]** — same‑root sibling term; the instrument used to perform [[ophthalmoscopy]]; shares *[[ophthalm-]]* + *[[-scope]]*.
...
> |Code|Description|
> |---|---|
> |**[[E11.319]]**|Type 2 diabetes mellitus with unspecified diabetic retinopathy without macular edema (most common code for initial ophthalmoscopy screening)|
> |**[[E11.321]]**|Type 2 diabetes mellitus with mild nonproliferative diabetic retinopathy, right eye|
> |**[[E11.322]]**|Type 2 diabetes mellitus with mild nonproliferative diabetic retinopathy, left eye|
> |**[[E11.329]]**|Type 2 diabetes mellitus with mild nonproliferative diabetic retinopathy, unspecified eye|
> |**[[E11.331]]**|Type 2 diabetes mellitus with moderate nonproliferative diabetic retinopathy, right eye|
> |**[[E11.332]]**|Type 2 diabetes mellitus with moderate nonproliferative diabetic retinopathy, left eye|
> |**[[E11.341]]**|Type 2 diabetes mellitus with severe nonproliferative diabetic retinopathy, right eye|
> |**[[E11.342]]**|Type 2 diabetes mellitus with severe nonproliferative diabetic retinopathy, left eye|
...
> |Code|Description|
> |---|---|
> |**[[H35.033]]**|Hypertensive retinopathy, bilateral (most common code for fundoscopic changes of hypertension)|
...
> |Code|Description|
> |---|---|
> |**[[H40.11]]**|Primary open‑angle glaucoma, mild stage (optic disc cupping visible on ophthalmoscopy)|
> |**[[H40.12]]**|Primary open‑angle glaucoma, moderate stage|
> |**[[H40.13]]**|Primary open‑angle glaucoma, severe stage|
> |**[[H40.001]]**|Preglaucoma (ocular hypertension), unspecified eye|
> 
> #### Papilledema and Optic Disc Findings (H47.1)
> 
> |Code|Description|
> |---|---|
> |**[[H47.13]]**|Papilledema associated with increased intracranial pressure, bilateral|
> |**[[H47.11]]**|Papilledema, right eye|
> |**[[H47.12]]**|Papilledema, left eye|
> |**[[H47.141]]**|Drusen of optic disc, right eye|
> |**[[H47.142]]**|Drusen of optic disc, left eye|
> 
> #### Retinal Detachment and Breaks (H33)
> 
> |Code|Description|
> |---|---|
> |**[[H33.00]]**|Retinal detachment with retinal break, unspecified eye (diagnosed via indirect ophthalmoscopy)|
> |**[[H33.01]]**|Retinal detachment with single break, right eye|
> |**[[H33.02]]**|Retinal detachment with single break, left eye|
> |**[[H33.31]]**|Retinal break without detachment, right eye|
> |**[[H33.32]]**|Retinal break without detachment, left eye|
> 
> #### Age‑related Macular Degeneration (H35.3)
> 
> |Code|Description|
> |---|---|
> |**[[H35.31]]**|Nonexudative age‑related macular degeneration, right eye (drusen visible on ophthalmoscopy)|
...
> |Code|Description|
> |---|---|
> |**[[Z01.00]]**|Encounter for examination of eyes and vision without abnormal findings (use when ophthalmoscopy is normal)|
...
>[!tip]- DERIVATIONS of [[ophthalmoscopy]]
>```dataview
>TABLE definition AS Definition
>FROM #medterm 
>WHERE length(filter(roots, (word) => econtains([[ophthalmoscopy]].roots, word))) > 0 AND file.name != [[ophthalmoscopy]].file.name
>SORT file.name ASC
>```
...
>TABLE definition AS Definition
>FROM #medterm 
>WHERE length(filter(definition, (word) => econtains([[ophthalmoscopy]].definition, word))) > 0 AND file.name != [[ophthalmoscopy]].file.name
>```
