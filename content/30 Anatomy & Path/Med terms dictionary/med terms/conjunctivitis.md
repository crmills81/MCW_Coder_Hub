...
> [!note] DEFINITION of [[conjunctivitis]]
...
_____
>[!info]+ ETYMOLOGY of [[conjunctivitis]]
>#latin 
>Derived from two parts:
>
>- **[[conjunctiva]]:** From the Latin _conjungere_, meaning "**to join together.**" It refers to the membrane that "**joins**" the eyeball to the eyelid.
...
> 
> - **[[Keratoconjunctivitis]]:** Inflammation involving both the conjunctiva and the cornea (more serious).
> - **[[Blepharoconjunctivitis]]:** Inflammation of both the eyelids ([[blepharitis]]) and the conjunctiva.
> - **[[Chemosis]]:** [[edema]] (**swelling**) of the [[conjunctiva]], making it look gelatinous.
> - **[[Subconjunctival Hemorrhage]]:** Bleeding under the conjunctiva; looks dramatic but is distinct from conjunctivitis (usually painless and no discharge).
> - **[[Ophthalmia Neonatorum]]:** Conjunctivitis occurring in the first 28 days of life, often due to exposure to pathogens during birth.
> - **[[Giant Papillary Conjunctivitis (GPC)]]:** Often associated with contact lens wear or ocular prosthetics.
>
_____

> [!example]+ **CODING AND NUANCES**
> 
> **ICD-10-CM Codes** _Note: Specificity regarding the cause (viral, bacterial, allergic) and laterality (right, left, bilateral) is required._
> 
...
>     
>     - _Laterality modifiers are applied at the 6th/7th character level in some systems, but B30 codes often require an additional code from category H10.- if not integrated. Wait, B30 is the etiology. The manifestation code is usually H10.- with the organism specified. Let's correct to the standard H10 series which includes etiology in modern ICD-10-CM._
>     - _Correction:_ In ICD-10-CM, conjunctivitis is primarily coded under **H10**. The organism is often indicated by the specific H10 code or an additional B code.
...
>     
>     _Refined Specific Codes (2026 Standard):_
>     
...
>     - **B30.8**: Other viral conjunctivitis
>     - **B30.9**: Viral conjunctivitis, unspecified _(Note: When a specific virus like Adenovirus is identified, the B30 code takes precedence or is used in conjunction depending on coding guidelines. Usually, B30.1 is sufficient for Adenoviral conjunctivitis)._
> 
...
> - _Wait, there is a specific category for Allergic Conjunctivitis?_
...
> 
> **CPT Codes** _CPT codes depend on the level of service (exam) or procedures performed (foreign body removal, culture)._
> 
...
_____
>[!tip]- DERIVATIONS of [[conjunctivitis]]
>```dataview
