...
alphabet:
  - S
definition: Acute inflammation and edema of the supraglottic structures — including the epiglottis, aryepiglottic folds, arytenoids, and false vocal cords — that can rapidly progress to life-threatening airway obstruction.
---

>[!Note] DEFINITION of [[supraglottitis]]
...
> - **Supraglottitis with obstruction** _(billable code for supraglottitis complicated by airway obstruction — [[J04.31]]; requires urgent airway management)_
> - **Infectious supraglottitis** _(bacterial etiology — most common cause; *H. influenzae*, group A strep, *S. pneumoniae*)_
> - **Non-infectious supraglottitis** _(caused by thermal/chemical inhalation, caustic ingestion, or foreign body; coded to [[J04.30]] or [[J04.31]] with additional external cause code)_
...
> |Code|Description|
> |---|---|
> |**J04.3**-|Supraglottitis, unspecified — *parent code, NOT billable; obstruction status required*|
> |**[[J04.30]]**|Supraglottitis, unspecified, without obstruction|
> |**[[J04.31]]**|Supraglottitis, unspecified, with obstruction|
>
> #### Related Supraglottic / Epiglottic Conditions
>
> |Code|Description|
> |---|---|
...
> |**[[J04.20]]**|Acute laryngotracheitis|
> |**[[J38.5]]**|Laryngismus (stridulus) — Excludes2 from J04.3|
> |**[[C32.1]]**|Malignant neoplasm of supraglottis — used as principal/secondary dx when supraglottic obstruction is neoplastic in origin|
>
> ---
>
> ### 🔧 COMMON CPT CODES (Supraglottitis-Related Diagnosis & Treatment)
>
> |CPT Code|Description|
> |---|---|
> |**[[31575]]**|Laryngoscopy, flexible, diagnostic — primary diagnostic procedure for supraglottitis in the stable patient|
> |**[[31526]]**|Laryngoscopy, direct, with operating microscope or telescope — diagnostic with enhanced visualization|
> |**[[31500]]**|Intubation, endotracheal, emergency procedure — used in supraglottitis with impending or active airway obstruction|
> |**[[31600]]**|Tracheostomy, planned (separate procedure) — surgical airway when intubation is not possible|
> |**[[31601]]**|Tracheostomy, younger than 2 years — pediatric airway emergency|
> |**[[31420]]**|Epiglottidectomy — surgical removal of the epiglottis; rare, reserved for recurrent supraglottitis/epiglottitis|
> |**[[31561]]**|Laryngoscopy, direct, operative, with arytenoidectomy — when arytenoid involvement requires surgical intervention|
> |**[[70360]]**|Radiologic examination, neck, soft tissue — AP/lateral neck X-ray to evaluate for "thumb sign" or soft tissue swelling|
> |**[[70486]]**|CT, maxillofacial area, without contrast — CT neck for abscess evaluation in stable patients|
> |**[[70487]]**|CT, maxillofacial area, with contrast — preferred CT neck with contrast for epiglottic abscess workup|
>
> ---
>
...
>[!tip]- DERIVATIONS of [[supraglottitis]]
>```dataview
>TABLE definition AS Definition
>FROM #medterm 
>WHERE length(filter(roots, (word) => econtains([[supraglottitis]].roots, word))) > 0 AND file.name != [[supraglottitis]].file.name
>SORT file.name ASC
>```
...
>TABLE definition AS Definition
>FROM #medterm 
>WHERE length(filter(definition, (word) => econtains([[supraglottitis]].definition, word))) > 0 AND file.name != [[supraglottitis]].file.name
>```
