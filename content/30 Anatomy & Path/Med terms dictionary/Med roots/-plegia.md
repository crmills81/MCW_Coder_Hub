...
alphabet:
  - P
definition: A suffix meaning complete paralysis or cessation of motion in the limb or body region specified by the initial element, derived from the Greek word for a blow or stroke
---
...
>|---|---|---|
>|**[[-plegia]]**|Greek _πληγή_ (plēgḗ), from _πλήσσειν_ (plēssein)|"**blow,**" "**stroke,**" "**to strike**" — Noun-forming suffix — "**paralysis, cessation of motion**" — originally referencing the blow or strike that causes the paralysis|
...
> ---
>
> ### 🔧 COMMON CPT CODES (-plegia-Related Diagnosis & Treatment)
>
> |CPT Code|Description|
> |---|---|
> |**[[95860]]**|Needle EMG, one extremity with related paraspinal muscles (evaluates motor unit integrity in plegic limb)|
