...
alphabet:
  - S
definition: A Greek-derived prefix meaning "with," "together," or "joined," used in medical terminology to indicate union, junction, simultaneous occurrence, or structural fusion of anatomical parts or physiological processes
---

>[!Note] DEFINITION of [[sym-]]
...
>[!info]+ ETYMOLOGY of [[sym-]]
>#greek
>
>|Component|Origin|Meaning|
>|---|---|---|
>|**[[sym-]]** / **[[syn-]]**|Greek _syn_ (sin), a preposition and prefix, from Proto-Indo-European _*ksun_ ("together with, along with")|"**with**," "**together**," "**along with**," "**at the same time**" — directional/associative prefix; *sym-* is the assimilated form used before b, m, p, ph; *syn-* is the base form used elsewhere|
>|**-m- (assimilation)**|Greek phonological rule: *n* → *m* before bilabial stops (b, p, m, ph)|Consonant assimilation — the nasal *n* in *syn-* shifts to the bilabial *m* to match the place of articulation of the following consonant; purely phonological, no change in meaning|
>
...
> ### 🏥 ICD-10-CM CODES
>
> #### Symphysis & Fibrocartilaginous Joint Disorders (M53.x)
>
> |Code|Description|
> |---|---|
> |**[[M53.3]]**|Sacrococcygeal disorders NEC (includes symphysis disruption)|
> |**[[M53.86]]**|Other specified dorsopathies, lumbar region|
> |**[[M53.88]]**|Other specified dorsopathies, sacral and sacrococcygeal region|
>
> #### Synostosis — Congenital Bony Fusions (Q74.x, Q75.x)
>
> |Code|Description|
> |---|---|
> |**[[Q74.0]]**|Other congenital malformations of upper limb(s), including shoulder girdle (includes radioulnar synostosis)|
...
>
> #### Syndactyly — Digital Fusion (Q70.x — Type & Site Required)
>
> |Code|Description|
> |---|---|
...
>
> #### Synovitis & Tenosynovitis (M65.x — Site Required)
>
> |Code|Description|
> |---|---|
...
>
> #### Sympathetic Nervous System Disorders (G90.x)
>
> |Code|Description|
> |---|---|
...
> |**[[G90.2]]**|Horner's syndrome (OTO/ophthalmology high relevance)|
> |**[[G90.3]]**|Multi-system degeneration of the autonomic nervous system|
> |**[[G90.50]]**|Complex regional pain syndrome I, unspecified|
> |**[[G90.511]]**|Complex regional pain syndrome I, right upper limb|
> |**[[G90.512]]**|Complex regional pain syndrome I, left upper limb|
> |**[[G90.513]]**|Complex regional pain syndrome I, upper limb, bilateral|
> |**[[G90.519]]**|Complex regional pain syndrome I, unspecified upper limb|
> |**[[G90.521]]**|Complex regional pain syndrome I, right lower limb|
> |**[[G90.522]]**|Complex regional pain syndrome I, left lower limb|
> |**[[G90.523]]**|Complex regional pain syndrome I, lower limb, bilateral|
> |**[[G90.529]]**|Complex regional pain syndrome I, unspecified lower limb|
> |**[[G90.59]]**|Complex regional pain syndrome I, other specified site|
> |**[[G90.8]]**|Other disorders of autonomic nervous system|
> |**[[G90.9]]**|Disorder of the autonomic nervous system, unspecified|
>
> #### Horner's Syndrome — Ophthalmology/OTO Intersection (G90.2)
>
> |Code|Description|
> |---|---|
> |**[[G90.2]]**|Horner's syndrome (ptosis + miosis + anhidrosis — sympathetic chain disruption; relevant in OTO neck dissection and ophthalmology)|
> |**[[H57.011]]**|Horner's syndrome, right eye (ophthalmic manifestation code — use with G90.2)|
> |**[[H57.012]]**|Horner's syndrome, left eye|
> |**[[H57.013]]**|Horner's syndrome, bilateral|
> |**[[H57.019]]**|Horner's syndrome, unspecified eye|
>
> ---
>
> ### 🔧 COMMON CPT CODES (sym-/syn- Related Procedures)
>
> |CPT Code|Description|
> |---|---|
> |**[[64505]]**|Injection, anesthetic agent; sphenopalatine ganglion — sympathetic nerve block of head/neck region|
> |**[[64510]]**|Injection, anesthetic agent; stellate ganglion (cervical sympathetic) — sympathetic nerve block; OTO/pain management|
> |**[[64520]]**|Injection, anesthetic agent; lumbar or thoracic (paravertebral sympathetic) — sympathetic nerve block|
> |**[[64550]]**|Application of surface neurostimulator — sympathetic modulation; used in CRPS management|
> |**[[64561]]**|Percutaneous implantation of neurostimulator electrode; sacral nerve (transforaminal) — autonomic/sympathetic application|
> |**[[27570]]**|Manipulation of knee joint under general anesthesia — synostosis/arthrofibrosis management|
> |**[[26560]]**|Repair of syndactyly (web finger) each web space; without skin graft|
> |**[[26561]]**|Repair of syndactyly (web finger) each web space; with skin graft|
> |**[[26562]]**|Repair of syndactyly (web finger) each web space; complex (e.g., involving bone, nails)|
> |**[[28280]]**|Syndactylization of toes (e.g., webbing or fusion of toes)|
> |**[[20610]]**|Arthrocentesis, aspiration and/or injection; major joint or bursa (e.g., knee, hip) — diagnostic/therapeutic for synovitis|
> |**[[20611]]**|Arthrocentesis, aspiration and/or injection; major joint with ultrasound guidance|
>
> ---
>
...
>[!tip]- DERIVATIONS of [[sym-]]
>```dataview
>TABLE definition AS Definition
>FROM #medroot 
>WHERE length(filter(roots, (word) => econtains([[sym-]].roots, word))) > 0 AND file.name != [[sym-]].file.name
>SORT file.name ASC
>```
...
>TABLE definition AS Definition
>FROM #medroot 
>WHERE length(filter(definition, (word) => econtains([[sym-]].definition, word))) > 0 AND file.name != [[sym-]].file.name
>```
