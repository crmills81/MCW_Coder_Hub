...
alphabet:
  - P
definition: An adjective-forming suffix derived from the Greek root pleg- (to strike) combined with the adjectival suffix -ic, used to describe a person, condition, or body part characterized by complete paralysis in the region specified by the prefix element
---
...
>[!info]+ ETYMOLOGY of [[-plegic]]
>#greek | #latin
>
>|Component|Origin|Meaning|
>|---|---|---|
>|**[[pleg-]]** / **[[pleg/o]]**|Greek _πληγή_ (plēgḗ), from _πλήσσειν_ (plēssein)|"**blow,**" "**stroke,**" "**a striking wound**" — the combining root shared by -plegia, -plegic, and -plexy|
>|**[[-ic]]**|Greek _-ικός_ (-ikos), via Latin _-icus_, via Old French _-ique_|Adjective-forming suffix — "**pertaining to,**" "**characterized by,**" "**of the nature of**" — one of the most productive adjectival suffixes in all of medical terminology|
>|**[[-plegic]]**|Neo-Latin _-plegicus_, from Greek _πληγή_ (plēgḗ) + _-ικός_ (-ikos)|"**pertaining to paralysis**," "**struck by paralysis**" — full adjectival compound; the form required when describing a patient's status or a condition's character|
>
...
> ---
>
> ### 🔧 COMMON CPT CODES (-plegic Patient Workup & Management)
>
> |CPT Code|Description|
> |---|---|
> |**[[95860]]**|Needle EMG, one extremity with related paraspinal muscles (differentiates UMN vs. LMN etiology in plegic limb)|
...
>[!tip]- DERIVATIONS of [[-plegic]]
>```dataview
>TABLE definition AS Definition
>FROM #medterm
>WHERE length(filter(roots, (word) => econtains([[-plegic]].roots, word))) > 0 AND file.name != [[-plegic]].file.name
>SORT file.name ASC
>```
...
>TABLE definition AS Definition
>FROM #medterm
>WHERE length(filter(definition, (word) => econtains([[-plegic]].definition, word))) > 0 AND file.name != [[-plegic]].file.name
>```
