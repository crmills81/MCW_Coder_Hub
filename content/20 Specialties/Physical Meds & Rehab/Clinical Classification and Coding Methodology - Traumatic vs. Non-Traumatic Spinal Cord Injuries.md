...
### SCI-Related Terminology Analysis

| Term             | Prefix Breakdown  | Clinical Definition                                                   |
| ---------------- | ----------------- | --------------------------------------------------------------------- |
| **[[Paraplegia]]**   | _Para-_ (Beside)  | Paralysis affecting the lower portion of the body.                    |
| **[[Tetraplegia]]**  | _Tetra-_ (Four)   | Paralysis of all four limbs and torso.                                |
| **[[Quadriplegia]]** | _Quadric-_ (Four) | Paralysis affecting all four extremities.                             |
| **[[Hemiparesis]]**  | _Hemi-_ (Half)    | Weakness or slight paralysis affecting one vertical half of the body. |
| **[[Paraparesis]]**  | _Para-_ (Beside)  | Partial paralysis or weakness of the lower extremities.               |
