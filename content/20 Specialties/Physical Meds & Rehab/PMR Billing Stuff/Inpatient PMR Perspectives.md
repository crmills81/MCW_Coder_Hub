 ...
 *PM&R Context:* Ischemic strokes or brain [[aneurysm]]s transitioning to the rehab phase, where the physician reviews neuroimaging already obtained (CT/MRI brain) to assess residual deficits and determine "**rehabilitation potential**" — this independent review directly supports higher-complexity MDM when properly documented (see Section 3).
