...
1. [[#🧭 Z Code Fundamentals in PM&R|Z Code Fundamentals in PM&R]]
2. [[#🔑 Principal Diagnosis Rules — When Z Codes Lead|Principal Diagnosis Rules]]
3. [[#🩹 Z47 — Aftercare Following Orthopedic Procedures|Z47 — Orthopedic Aftercare]]
4. [[#🩺 Z48 — Aftercare Following Surgical Procedures|Z48 — Post-Surgical Aftercare]]
5. [[#💊 Z51 — Encounter for Other Aftercare and Medical Care|Z51 — Other Aftercare]]
6. [[#🧍 Z74 — Problems Related to Care Provider Dependency|Z74 — Care Provider Dependency]]
7. [[#📜 Z82 — Family History Relevant to PM&R|Z82 — Family History]]
8. [[#📋 Z86 — Personal History Relevant to PM&R|Z86 — Personal History]]
9. [[#📁 Z87 — Personal History of Other Conditions|Z87 — Personal History Other]]
10. [[#🦾 Z96 — Presence of Functional Implants|Z96 — Functional Implants]]
11. [[#🔌 Z99 — Dependence on Enabling Machines and Devices|Z99 — Device Dependence]]
12. [[#🏥 Encounter Type Coding Guidance|Encounter Type Coding Guidance]]
	- [[#Inpatient Rehab Facility (IRF) Admissions|IRF Admissions]]
	- [[#Acute Care Rehab Consults|Acute Care Rehab Consults]]
	- [[#Post-Surgical Rehabilitation|Post-Surgical Rehabilitation]]
	- [[#Spinal Cord and TBI Rehabilitation|Spinal Cord and TBI Rehabilitation]]
13. [[#🧾 CPT Code Reference — PM&R Therapeutic Services|CPT Code Reference]]
	- [[#Therapeutic Procedures|Therapeutic Procedures]]
	- [[#Physical Therapy Evaluations|Physical Therapy Evaluations]]
	- [[#Occupational Therapy Evaluations|Occupational Therapy Evaluations]]
	- [[#Speech-Language Pathology|Speech-Language Pathology]]
	- [[#Physical Agent Modalities|Physical Agent Modalities]]
	- [[#Neuromuscular Reeducation and Functional Training|Neuromuscular and Functional]]
14. [[#📊 MS-DRG Considerations — PM&R|MS-DRG Considerations]]
15. [[#📌 Coding Scenarios — High-Yield Clinical Situations|Coding Scenarios]]
16. [[#❓ Common Queries for PM&R Encounters|Common CDI Queries]]
17. [[#🔍 Related Notes (Link When Built)|Related Notes]]

---

## 🧭 Z Code Fundamentals in PM&R

> [!info] What Z Codes Do in PM&R
...
## 🔑 Principal Diagnosis Rules — When Z Codes Lead

> [!warning] PDX Decision Tree for PM&R Inpatient
...
## 🩹 Z47 — Aftercare Following Orthopedic Procedures

> [!note] Z47 — High-Frequency PM&R Codes
...
## 🩺 Z48 — Aftercare Following Surgical Procedures

> [!note] Z48 — Post-Surgical Aftercare
...
| Code | Description |
|---|---|
| **[[Z48.3]]** | Aftercare following surgery for neoplasm | Post-oncologic surgery rehab |

### Z48.8 — Aftercare Following Other Surgical Procedures
...
> [!note] Z74 — Functional Status and Care Dependency
...
| **[[Z74.1]]**  | Need for assistance with personal care                                     | ADL dependency — bathing, dressing, grooming           |
| **[[Z74.2]]**  | Need for assistance at home, no other household member able to render care | Caregiver unavailability — supports discharge planning |
...
| **[[Z74.9]]**  | Problem related to care provider dependency, unspecified                   | Avoid — use specific code                              |
...
## 📜 Z82 — Family History Relevant to PM&R

> [!note] Z82 — Family History
...
> [!tip] Z82 Usage Note
> **Z82 codes** are rarely **PDX** and rarely drive **DRG**. Include them when documented and clinically relevant to the current encounter — particularly in cardiac and neuro rehab where family history affects care planning.

---

## 📋 Z86 — Personal History Relevant to PM&R

> [!note] Z86 — Personal History of Diseases
...
> [!note] Z87 — Highly Relevant to PM&R Rehab Planning
...
> [!note] Z96 — Joint Prosthesis Status Codes
> **Z96** codes are **status codes** — they document that the patient currently has an implant in place. Always secondary. Critical companions to **Z47.1** (joint replacement aftercare).
...
> [!note] Z99 — Device Dependence Status
> **Z99** codes are critical in complex **PM&R** patients — especially **SCI**, **TBI**, and post-ICU rehab where patients may be ventilator-dependent, trach-dependent, or wheelchair-dependent.
...
**Coding pearls:**
- **[[Z99.11]**] in an IRF/acute care setting significantly impacts **DRG complexity** — always capture if documented
- **[[Z99.3]]** supports medical necessity for wheelchair-level mobility training in IRF
- Trach dependence: **[[Z93.0]]** ([[tracheostomy]] status) — different category but frequently co-occurs with **Z99.11** in PM&R
- Feeding tube: **[[Z93.1]]** ([[gastrostomy]] status) — another status code that pairs with **Z99.89**
...
> [!warning] Acute Care Setting — Z Codes are Secondary
...
> [!note] Post-Surgical Rehab — Z48 and Z47 Decision
...
> [!note] SCI and TBI Rehab — Complex Coding
...
## 🧾 CPT Code Reference — PM&R Therapeutic Services

> [!tip] CPT in the Inpatient Setting
...
| **[[97129]]** | Therapeutic intervention, cognitive function — initial 15 min         | Yes                |
| **[[97130]]** | Therapeutic intervention, cognitive function — each additional 15 min | Yes                |
...
> [!warning] Modalities Require Concurrent Skilled Care
...
### Behavior Analysis (ABA — Autism/Cognitive Rehab)
...
## 📊 MS-DRG Considerations — PM&R

> [!note] DRGs Most Common in PM&R-Heavy Cases
...
- **Secondary:** [[M16.11]] — Unilateral primary osteoarthritis, right hip (underlying condition)
...
- **PDX:** [[Z51.89]] — Encounter for other specified aftercare (stroke resolved, rehab phase)
- **Secondary:** [[G81.92]] — Hemiplegia, unspecified, affecting dominant side
- **Secondary:** [[R47.01]] — Aphasia
- **Secondary:** [[R13.12]] — Dysphagia, oropharyngeal phase
- **Secondary:** [[Z86.73]] — Personal history of TIA/cerebral infarction without residual (if applicable)
...
- **PDX:** [[Z47.81]] — Orthopedic aftercare following surgical amputation
- **Secondary:** [[Z89.512]] — Acquired absence of left leg below knee
- **Secondary:** [[Z74.09]] — Reduced mobility
- **CPT (profee):** [[97761]] — Prosthetic training
- **DRG:** 560 or 561
...
- **PDX:** [[Z48.812]] — Aftercare following surgery on the circulatory system
- **Secondary:** [[I25.10]] — Atherosclerotic heart disease, native coronary artery
...
- **Secondary:** [[Z74.3]] — Need for continuous supervision
- **CPT (profee):** [[97129]] + [[97130]] — Cognitive therapeutic intervention
- **DRG:** 945 or 946
...
> [!question] CDI Queries — PM&R Z Code Situations

- "The patient was admitted for inpatient rehabilitation following total knee replacement. Can you confirm the patient is no longer in the acute post-operative phase and is admitted solely for rehabilitation purposes?"
- "Documentation reflects hemiplegia and aphasia following a prior stroke. Can you confirm whether the cerebral infarction is **resolved** with residual deficits, or whether the CVA is still considered active?"
- "The patient is noted to require supervision for all activities due to cognitive impairment. Can you document the specific cognitive deficits (**memory, executive function, orientation**) and confirm the level of supervision required?"
- "The patient is wheelchair-dependent. Can you document whether this is a **permanent** functional status or an expected temporary limitation?"
- "Documentation references deconditioning. Can you identify and document the **underlying etiology** of the deconditioning (**e.g., prolonged hospitalization, post-COVID, malnutrition, cardiac disease**)?"
- "The patient has a history of stroke. Can you clarify whether there are **any residual neurological deficits** from the prior stroke that are affecting this admission?"
- "Malnutrition is suspected given the patient's weight loss and albumin level. Can you confirm presence and severity of malnutrition (**mild, moderate, severe**)?"

---

## 🔍 Related Notes (Link When Built)

- [[PM&R DRG Reference — 945 and 946]]
- [[Spinal Cord Injury Coding — G82 and S-Codes]]
- [[TBI Coding Reference — S06 and Residuals]]
...
*Sources: ICD-10-CM FY2026 Official Guidelines; CMS MS-DRG Grouper v41; CMS IRF PPS Classification; AMA CPT 2026; AAPC CIC Study Resources.*<sup>1,2,3,4</sup>