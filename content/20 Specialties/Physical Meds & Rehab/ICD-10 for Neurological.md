# ICD-10 for Neurological (Chapter 6)
...
## Key Categories for PM&R

### Stroke/CVA (I60-I69)
| Code | Description |
| :--- | :--- |
| **I63.50** | Cerebral infarction due to unspecified occlusion |
| **I69.351** | Monoplegia of upper limb following cerebral infarction |
| **I69.352** | Monoplegia of lower limb following cerebral infarction |
| **I69.391** | Other sequelae of cerebral infarction |

> [!IMPORTANT] Stroke Specificity
> Stroke codes require:
> - Type of stroke (hemorrhagic vs. ischemic)
> - Side affected (left/right)
> - Dominance (dominant/non-dominant side)
> - Time since event (acute vs. sequelae)
...
| **G95.9** | Spinal cord disease, unspecified |
...
> [!WARNING] Acute vs. Chronic
> Do not use acute stroke codes (I60-I64) for patients in rehabilitation after the acute phase. Use sequelae codes (I69) instead.

## Functional Neurological Codes
| Code | Description |
| :--- | :--- |
