...
> **Approach is King:** You cannot use Open codes (50xxx) for Laparoscopic/Robotic cases (505xx).
> **"Radical":** Means removing the kidney, perirenal fat, adrenal gland (usually), and Gerota's fascia.
...
### ⚠️ Modifier Watch
- [x] **[[-50]] (Bilateral):** Rare, but allowed if removing *both* kidneys (e.g., bilateral cancer or harvest).
- [ ] **[[-LT]] / [[-RT]]:** Mandatory.
