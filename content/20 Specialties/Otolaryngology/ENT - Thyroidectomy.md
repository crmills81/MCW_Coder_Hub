...
1.  **"Berry Picking":** If the surgeon says "sampled lymph nodes," that is incidental and **bundled**. Do not bill +60512 unless they describe a distinct "compartment dissection" (Levels VI, etc.).
2.  **Parathyroids:** Re-implanting a parathyroid gland (auto-transplantation) that was accidentally removed is usually **bundled** (+60512 is for *parathyroidectomy*, not reimplantation).

![[Pasted image 20260122223415.png]]
