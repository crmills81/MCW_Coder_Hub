...
> **The Age Cutoff:** T&A codes change strictly at **Age 12**.
> *Under 12* = Higher RVU (more risk). *12 and Over* = Lower RVU.
> **Bundling:** Control of bleeding (primary) is included. Do not bill for cautery during the initial surgery.
...
- [x] **-50 (Bilateral):** **NO.** These codes are inherently bilateral ("Tonsils" plural). Do not use -50.
