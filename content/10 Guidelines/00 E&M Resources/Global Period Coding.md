...
- **Restriction:** This does _not_ apply to minor procedures (0 or 10-day global periods). The decision to perform a minor procedure is bundled,.
...
**New for 2025 (Medicare):** If you are a practitioner who did **not** perform the surgery (and are not in the same group) but are providing a post-operative follow-up visit _without_ a formal transfer of care, you may be able to report the new add-on code **G0559**,.
...
|Modifier | Use Case | Starts New Global Period?|Payment Impact|
|:--|:--|:--|:--|
|**[[-58]]**|**Planned** / Staged Procedure|**Yes**|100% of Allowable|
|**[[-78]]**|**Unplanned** Return to OR (Complication)|**No**|Intra-operative % Only|
|**[[-55]]**|Taking over **Post-Op Care** only | N/A (Part of original)|Post-op % Only|
