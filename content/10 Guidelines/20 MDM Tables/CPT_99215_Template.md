...
**Vital Signs:**  
BP: ___/___  HR: _____  RR: _____  Temp: _____  O₂ Sat: _____  BMI: _____
...
| History taking | _____ | Comprehensive HPI, ROS, PFSH |
| Physical examination | _____ | Multi-system exam |
| Reviewing test results/images | _____ | _________________ |
| Clinical staff time (chart prep) | _____ | (Not counted if not incident-to) |
| Medical decision-making/documentation | _____ | Treatment plan, consultations |
| Patient counseling/education | _____ | _________________ |
| Care coordination with other providers | _____ | _________________ |
| **TOTAL TIME** | **_____** | **≥40 minutes required** |
...
- **99215: Comprehensive history/exam, HIGH complexity MDM** ✅ **APPROPRIATE**
